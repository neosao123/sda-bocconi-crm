...
//paceholder function to avoid errors from ajax.js

function nxTinyMCEPlain() {
    //just a place holder
}

function nxTinyMCEBasic() {
    //just a place holder
}

function nxTinyMCELite() {
    //just a place holder
}

function nxTinyMCEExtended() {
    //just a place holder
}

function nxTinyMCEExtendedLite() {
    //just a place holder
}