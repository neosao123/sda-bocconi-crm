    ...
    <div id="list-page-actions">
        ...
        <?php if(config('visibility.archived_tickets_toggle_button')): ?>
            <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.show_archive_tickets'))); ?>"
                ...
                class="list-actions-button btn btn-page-actions archive-border waves-effect waves-dark js-ajax-ux-request <?php echo e(runtimeActive(auth()->user()->pref_filter_show_archived_tickets)); ?>"
        ...
        <?php if(config('visibility.list_page_actions_add_button_link')): ?>
            <button id="fx-page-actions-add-button" type="button" class="btn-create edit-add-modal-button"
...
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/tickets/components/misc/list-page-actions.blade.php ENDPATH**/ ?>