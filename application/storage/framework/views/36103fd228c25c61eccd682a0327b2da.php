...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>" id="list-page-actions-container">
  <div id="list-page-actions">
    ...
    <?php if(config('visibility.list_page_actions_exporting')): ?>
      <button type="button" data-toggle="tooltip" title="<?php echo app('translator')->get('lang.export_workorder'); ?>" class="list-actions-button btn btn-page-actions export-border  waves-effect waves-dark js-toggle-side-panel"
        data-target="sidepanel-export-workorder">
...
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/workorder/components/misc/list-page-actions.blade.php ENDPATH**/ ?>