    ...
    <div id="list-page-actions">
        ...
        <?php if(config('visibility.modules.reminders')): ?>
            <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.reminder'))); ?>"
                ...
                class="reminder-toggle-panel-button list-actions-button btn btn-page-actions ti-alarm-clock-border waves-effect waves-dark js-toggle-reminder-panel ajax-request <?php echo e($project->reminder_status); ?>"
        ...
        <?php if(auth()->user()->role->role_assign_projects == 'yes'): ?>
            <button type="button" title="<?php echo e(cleanLang(__('lang.assigned_users'))); ?>"
                class="data-toggle-action-tooltip list-actions-button sl-icon-people-border btn btn-page-actions waves-effect edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
        ...
        <?php if(config('visibility.edit_project_button')): ?>
            <span class="dropdown">
                <button type="button" data-toggle="dropdown" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                    ...
                    class="data-toggle-tooltip list-actions-button sl-icon-note-border  btn btn-page-actions waves-effect waves-dark">
        ...
        <?php if(config('visibility.delete_project_button')): ?>
            ...
            <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.delete_project'))); ?>"
                class="list-actions-button btn btn-page-actions waves-effect sl-icon-trash-border waves-dark confirm-action-danger"
                data-confirm-title="<?php echo e(cleanLang(__('lang.delete_project'))); ?>"
                data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>" data-ajax-type="DELETE"
                data-url="<?php echo e(url('/projects/' . $project->project_id . '?source=page')); ?>">
                <i class="bi bi-trash3 trash"></i>
        <?php endif; ?>
    </div>
</div>
<!-- action buttons -->
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/project/components/misc/actions.blade.php ENDPATH**/ ?>