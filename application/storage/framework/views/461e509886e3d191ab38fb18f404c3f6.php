    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                <i class="bi bi-funnel"></i><?php echo app('translator')->get('lang.filter_contracts'); ?>
                <span>
                    <i class="bi bi-x-circle js-close-side-panels" data-target="sidepanel-filter-contracts"></i>
                </span>
            </div>
...
<!--sidebar--><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/contracts/components/misc/filter-contracts.blade.php ENDPATH**/ ?>