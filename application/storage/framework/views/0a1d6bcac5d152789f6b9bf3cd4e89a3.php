<ul class="nav nav-tabs customtab" role="tablist">
    ...
    <li class="nav-item"> <a class="nav-link cursor-pointer <?php echo e($page['menutab_embed'] ?? ''); ?>"
            href="<?php echo e(url('/app/settings/formbuilder/'.$webform->webform_id.'/integrate')); ?>" role="tab"><span
                class="hidden-sm-up"><ion-icon name="mail-outline" class="email"></ion-icon></span> <span
                class="hidden-xs-down"><?php echo app('translator')->get('lang.embed_form'); ?></span></a>
    </li>
</ul><?php /**PATH /home/neosao-sdabocconicrm/htdocs/sdabocconicrm.neosao.co.in/application/resources/views/pages/settings/sections/formbuilder/misc/tabs.blade.php ENDPATH**/ ?>