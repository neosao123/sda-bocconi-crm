            ...
            <div class="x-meta p-t-15">
                ...
                <div class="projects_col_status m-b-9">
                    ...
                    <span class="projects_col_status label label-icons label-icons-default" data-toggle="tooltip"
                        data-placement="top" title="<?php echo app('translator')->get('lang.archived'); ?>">           <i class="bi bi-archive archive"></i>
                        </span>
                    <?php endif; ?>
                </div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/projects/views/cards/layout/ajax.blade.php ENDPATH**/ ?>