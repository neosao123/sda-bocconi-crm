...
<div class="card-show-form-data" id="card-lead-organisation">
    ...
    <?php if(config('visibility.lead_editing_buttons')): ?>
      <div class="form-data-row-buttons">
        <button type="button" class="btn waves-effect waves-light btn-xs btn-info ajax-request"
          data-url="<?php echo e(url('leads/content/' . getLeadId($lead)['leadId'] . '/edit-customfields?type=' . getLeadId($lead)['type'])); ?>" data-loading-class="loading-before-centre"
  ...
  <?php else: ?>
    <div class="x-no-result">
      ...
      <div class="p-t-20">
        <h4><?php echo e(cleanLang(__('lang.you_do_not_have_custom_fields'))); ?></h4>
      </div>
...
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/lead/content/customfields/show.blade.php ENDPATH**/ ?>