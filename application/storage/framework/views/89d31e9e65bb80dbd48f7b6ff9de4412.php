...
<div class="billing-mode-only-item">
  <span class="pull-left">
    <h3><b><?php echo e(cleanLang(__('lang.proforma_invoice'))); ?></b>
      <!--recurring icon-->
      
    </h3>
    <span>
      <h5>#<?php echo e($bill->formatted_bill_proforma_invoiceid); ?></h5>
    </span>
    
    <span><strong style="margin-right: 4px;"><?php echo e(__('lang.quotation')); ?> : </strong>#<?php echo e($bill->estimate->formatted_bill_estimateid); ?></span>
...
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/bill/components/elements/proforma-invoice/header-web.blade.php ENDPATH**/ ?>