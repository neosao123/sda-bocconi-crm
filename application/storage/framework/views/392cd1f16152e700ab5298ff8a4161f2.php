            ...
            <div class="card-body">
              ...
              <table id="demo-foo-addrow" class="table m-t-0 m-b-0 table-hover no-wrap app-modules" data-page-size="10">
                ...
                <tbody>
                  ...
                  <!--proforma invoice -->
                  <tr>
                    <td><?php echo app('translator')->get('lang.proforma_invoice'); ?></td>
                    <td>
                      <div class="form-group form-group-checkbox m-0 p-0">
                        <div class="col-2 text-right m-0 p-0">
                          <input type="checkbox" id="settings_modules_proforma_invoice" name="settings_modules_proforma_invoice" <?php echo e(runtimePrechecked($settings->settings_modules_proforma_invoice)); ?>

                            class="filled-in chk-col-light-blue">
                          <label class="m-0 p-0" for="settings_modules_proforma_invoice"></label>
                        </div>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group form-group-checkbox m-0 p-0">
                        <div class="col-2 text-right m-0 p-0">
                          <input type="checkbox" id="settings_modules_invoices" name="settings_modules_invoices" <?php echo e(runtimePrechecked($settings->settings_modules_invoices)); ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group form-group-checkbox m-0 p-0">
                        <div class="col-2 text-right m-0 p-0">
                          <input type="checkbox" id="settings_modules_payments" name="settings_modules_payments" <?php echo e(runtimePrechecked($settings->settings_modules_payments)); ?>
                  ...
                  <tr>
                    <td><?php echo app('translator')->get('lang.workorder'); ?> - <small>(<?php echo app('translator')->get('lang.linked_to_lead_quotation'); ?>)</small></td>
                    <td>
                      <div class="form-group form-group-checkbox m-0 p-0">
                        <div class="col-2 text-right m-0 p-0">
                          <input type="checkbox" id="settings_modules_workorder" name="settings_modules_workorder" <?php echo e(runtimePrechecked($settings->settings_modules_workorder)); ?>

                            class="filled-in chk-col-light-blue">
                          <label class="m-0 p-0" for="settings_modules_workorder"></label>
                        </div>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group form-group-checkbox m-0 p-0">
                        <div class="col-2 text-right m-0 p-0">
                          <input type="checkbox" id="settings_modules_knowledgebase" name="settings_modules_knowledgebase" <?php echo e(runtimePrechecked($settings->settings_modules_knowledgebase)); ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group form-group-checkbox m-0 p-0">
                        <div class="col-2 text-right m-0 p-0">
                          <input type="checkbox" id="settings_modules_estimates" name="settings_modules_estimates" <?php echo e(runtimePrechecked($settings->settings_modules_estimates)); ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group form-group-checkbox m-0 p-0">
                        <div class="col-2 text-right m-0 p-0">
                          <input type="checkbox" id="settings_modules_proposals" name="settings_modules_proposals" <?php echo e(runtimePrechecked($settings->settings_modules_proposals)); ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group form-group-checkbox m-0 p-0">
                        <div class="col-2 text-right m-0 p-0">
                          <input type="checkbox" id="settings_modules_contracts" name="settings_modules_contracts" <?php echo e(runtimePrechecked($settings->settings_modules_contracts)); ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group form-group-checkbox m-0 p-0">
                        <div class="col-2 text-right m-0 p-0">
                          <input type="checkbox" id="settings_modules_expenses" name="settings_modules_expenses" <?php echo e(runtimePrechecked($settings->settings_modules_expenses)); ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group form-group-checkbox m-0 p-0">
                        <div class="col-2 text-right m-0 p-0">
                          <input type="checkbox" id="settings_modules_subscriptions" name="settings_modules_subscriptions" <?php echo e(runtimePrechecked($settings->settings_modules_subscriptions)); ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group form-group-checkbox m-0 p-0">
                        <div class="col-2 text-right m-0 p-0">
                          <input type="checkbox" id="settings_modules_tickets" name="settings_modules_tickets" <?php echo e(runtimePrechecked($settings->settings_modules_tickets)); ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group form-group-checkbox m-0 p-0">
                        <div class="col-2 text-right m-0 p-0">
                          <input type="checkbox" id="settings_modules_messages" name="settings_modules_messages" <?php echo e(runtimePrechecked($settings->settings_modules_messages)); ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group form-group-checkbox m-0 p-0">
                        <div class="col-2 text-right m-0 p-0">
                          <input type="checkbox" id="settings_modules_reports" name="settings_modules_reports" <?php echo e(runtimePrechecked($settings->settings_modules_reports)); ?>
                  ...
                  <!--
                                                                                                                dt. 30-08-2024
                                                                                                                custom sections build by abhi harshe, #neosao
                                                                                                              -->
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/settings/sections/modules/page.blade.php ENDPATH**/ ?>