    ...
    <td class="category_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            <button type="button" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                class="data-toggle-tooltip  btn btn-outline-success btn-circle sl-icon-note-border  btn-sm edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.delete'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-danger btn-circle sl-icon-trash-border btn-sm confirm-action-danger"
...
<!--each row--><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/settings/sections/knowledgebase/table/ajax.blade.php ENDPATH**/ ?>