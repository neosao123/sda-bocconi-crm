    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                <i class="bi bi-funnel"></i><?php echo e(cleanLang(__('lang.filter_contacts'))); ?>

                <span>
                    <i class="bi bi-x-circle js-close-side-panels" data-target="sidepanel-filter-contacts"></i>
                </span>
            </div>
            <!--title-->
            <!--body-->
...
<!--sidebar--><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/contacts/components/misc/filter-contacts.blade.php ENDPATH**/ ?>