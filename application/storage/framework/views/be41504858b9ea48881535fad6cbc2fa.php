<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.timezone'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic-with-search form-control form-control-sm select2-preselected"
                    data-allow-clear="false"
                    data-preselected="<?php echo e($user->timezone ?? config('system.settings_system_timezone')); ?>"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <input type="text" class="form-control form-control-sm" id="social_twitter"
                            ...
                            placeholder="<?php echo e(cleanLang(__('lang.social_profile_link'))); ?>">
                    </div>
                </div>
                <!--facebook-->
                <div class="form-group row">
...
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/contacts/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>