...
<div class="reminders-none-existing" id="reminders-none-existing">
    <div class="x-image">
        <img src="<?php echo e(url('/public/images/reminders_none1.png')); ?>" alt="404 - Not found" />
    </div>
    <div class="x-text">
...
</div><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/reminders/misc/none-found.blade.php ENDPATH**/ ?>