...
<div class="card" id="project_details" data-progress="<?php echo e($project->project_progress); ?>">
    ...
    <div class="project-cover-image-wrapper js-hover-actions <?php echo e(config('visibility.project_cover_image_current')); ?>">
        ...
        <div class="js-hover-actions-target edit_project_cover_wrapper hidden" id="edit_project_cover_wrapper">
            <!--edit cover-->
            <button type="button"
                class="data-toggle-tooltip btn waves-effect btn-sm sl-icon-note-border  waves-light btn-rounded btn-info js-ajax-ux-request edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
            ...
            <button type="button" data-toggle="tooltip" title="<?php echo app('translator')->get('lang.remove_cover_image'); ?>"
                class="btn waves-effect btn-sm waves-light btn-rounded btn-danger sl-icon-trash-border data-toggle-action-tooltip confirm-action-danger"
...
<!-- Column --><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/project/components/misc/details.blade.php ENDPATH**/ ?>