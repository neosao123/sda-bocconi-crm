      ...
      <?php if(config('visibility.tasks_card_assigned')): ?>
        <div class="x-section">
          ...
          <?php if($task->permission_assign_users): ?>
            <span class="x-assigned-user x-assign-new js-card-settings-button-static card-task-assigned text-info" data-container=".card-modal" tabindex="0" data-popover-content="card-task-team"
      ...
      <div class="x-section">
        ...
        <?php if(config('visibility.tasks_standard_features')): ?>
          <div class="x-element" id="task-start-date"><i class="mdi mdi-calendar-plus"></i>
            ...
            <?php if($task->permission_edit_task): ?>
              <span class="x-highlight x-editable card-pickadate" data-url="<?php echo e(urlResource('/tasks/' . $task->task_id . '/update-start-date/')); ?>" data-type="form" data-progress-bar='hidden'
                data-form-id="task-start-date" data-hidden-field="task_date_start" data-container="task-start-date-container" data-ajax-type="post"
        ...
        <?php if(config('visibility.tasks_standard_features')): ?>
          <div class="x-element" id="task-due-date"><i class="mdi mdi-calendar-clock"></i>
            ...
            <?php if($task->permission_edit_task): ?>
              <span class="x-highlight x-editable card-pickadate" data-url="<?php echo e(urlResource('/tasks/' . $task->task_id . '/update-due-date/')); ?>" data-type="form" data-progress-bar='hidden'
                data-form-id="task-due-date" data-hidden-field="task_date_due" data-container="task-due-date-container" data-ajax-type="post"
        ...
        <div class="x-element" id="card-task-status"><i class="mdi mdi-flag"></i>
          ...
          <span class="x-highlight x-editable js-card-settings-button-static" data-container=".card-modal" id="card-task-status-text" tabindex="0" data-popover-content="card-task-statuses"
            data-offset="0 25%" data-status-id="<?php echo e($task->taskstatus_id); ?>" data-title="<?php echo e(cleanLang(__('lang.status'))); ?>"><?php echo e(runtimeLang($task->taskstatus_title)); ?></strong></span>
        ...
        <div class="x-element" id="card-task-priority"><i class="mdi mdi-flag"></i>
          ...
          <?php if($task->permission_edit_task): ?>
            <span class="x-highlight x-editable js-card-settings-button-static" data-container=".card-modal" id="card-task-priority-text" tabindex="0" data-popover-content="card-task-priorities"
              data-offset="0 25%" data-status-id="<?php echo e($task->taskpriority_id); ?>" data-title="<?php echo e(cleanLang(__('lang.priority'))); ?>"><?php echo e(runtimeLang($task->taskpriority_title)); ?></strong></span>
          <?php else: ?>
        ...
        <?php if(auth()->user()->type == 'team'): ?>
          <div class="x-element" id="card-task-client-visibility"><i class="mdi mdi-eye"></i>
            ...
            <?php if($task->permission_edit_task): ?>
              <span class="x-highlight x-editable js-card-settings-button-static" data-container=".card-modal" id="card-task-client-visibility-text" tabindex="0"
    ...
    <?php if(config('visibility.task_is_open')): ?>
      ...
      <div class="x-section">
        ...
        <?php if($task->permission_edit_task && auth()->user()->type == 'team'): ?>
          <div class="x-element x-action js-card-settings-button-static" data-container=".card-modal" id="card-task-milestone" tabindex="0" data-popover-content="card-task-milestones"
        ...
        <?php if($task->permission_super_user && config('visibility.tasks_standard_features')): ?>
          <div class="x-element x-action confirm-action-danger" data-confirm-title="<?php echo e(cleanLang(__('lang.stop_all_timers'))); ?>" data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>"
            data-url="<?php echo e(url('/')); ?>/tasks/timer/<?php echo e($task->task_id); ?>/stopall?source=card"><i class="mdi mdi-timer-off"></i>
        ...
        <?php if($task->permission_edit_task && config('visibility.tasks_standard_features')): ?>
          <div class="x-element x-action confirm-action-info  <?php echo e(runtimeActivateOrAchive('archive-button', $task->task_active_state)); ?> card_archive_button_<?php echo e($task->task_id); ?>"
            id="card_archive_button_<?php echo e($task->task_id); ?>" data-confirm-title="<?php echo e(cleanLang(__('lang.archive_task'))); ?>" data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>"
            data-ajax-type="PUT" data-url="<?php echo e(url('/')); ?>/tasks/<?php echo e($task->task_id); ?>/archive"><i class="mdi mdi-archive"></i> <span class="x-highlight"
              id="task-start-date"><?php echo e(cleanLang(__('lang.archive'))); ?></span></span></div>
          <?php $count_action ++ ; ?>
        <?php endif; ?>
        ...
        <?php if($task->permission_edit_task && runtimeArchivingOptions()): ?>
          <div class="x-element x-action confirm-action-info  <?php echo e(runtimeActivateOrAchive('activate-button', $task->task_active_state)); ?> card_restore_button_<?php echo e($task->task_id); ?>"
            id="card_restore_button_<?php echo e($task->task_id); ?>" data-confirm-title="<?php echo e(cleanLang(__('lang.restore_task'))); ?>" data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>"
            data-ajax-type="PUT" data-url="<?php echo e(url('/')); ?>/tasks/<?php echo e($task->task_id); ?>/activate"><i class="mdi mdi-archive"></i> <span class="x-highlight"
              id="task-start-date"><?php echo e(cleanLang(__('lang.restore'))); ?></span></span></div>
          <?php $count_action ++ ; ?>
        <?php endif; ?>
        ...
        <?php if($task->permission_delete_task && runtimeArchivingOptions()): ?>
          <div class="x-element x-action confirm-action-danger" data-confirm-title="<?php echo e(cleanLang(__('lang.delete_item'))); ?>" data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>"
            data-ajax-type="DELETE" data-url="<?php echo e(urlResource('/')); ?>/tasks/<?php echo e($task->task_id); ?>"><i class="mdi mdi-delete"></i> <span class="x-highlight"
              id="task-start-date"><?php echo e(cleanLang(__('lang.delete'))); ?></span></span></div>
          <?php $count_action ++ ; ?>
        <?php endif; ?>
            ...
            <tbody>
              ...
              <?php if(auth()->user()->is_team): ?>
                ...
                <tr>
                  ...
                  <td><strong><a href="<?php echo e(urlResource('/projects/' . $task->task_projectid)); ?>" target="_blank">#<?php echo e($task->project_id); ?></a></strong>
                  </td>
                </tr>
              <?php endif; ?>
            </tbody>
    ...
    <div class="hidden" id="card-task-statuses">
      <ul class="list">
        <?php $__currentLoopData = config('task_statuses'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task_status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <li class="card-tasks-update-status-link" data-button-text="card-task-status-text" data-progress-bar='hidden' data-url="<?php echo e(urlResource('/tasks/' . $task->task_id . '/update-status')); ?>"
            data-type="form" data-value="<?php echo e($task_status->taskstatus_id); ?>" data-form-id="--set-dynamically--" data-ajax-type="post">
      ...
      <div class="hidden" id="card-task-priorities">
        <ul class="list">
          <?php $__currentLoopData = config('task_priorities'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $priority): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="card-tasks-update-priority-link" data-button-text="card-task-priority-text" data-progress-bar='hidden'
              data-url="<?php echo e(urlResource('/tasks/' . $task->task_id . '/update-priority')); ?>" data-type="form" data-value="<?php echo e($priority->taskpriority_id); ?>" data-form-id="--set-dynamically--"
              data-ajax-type="post">
      ...
      <div class="hidden" id="card-task-priorities">
        <ul class="list">
          <?php $__currentLoopData = config('settings.task_priority'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="card-tasks-update-priority-link" data-button-text="card-task-priority-text" data-progress-bar='hidden'
              data-url="<?php echo e(urlResource('/tasks/' . $task->task_id . '/update-priority')); ?>" data-type="form" data-value="<?php echo e($key); ?>" data-form-id="--set-dynamically--"
              data-ajax-type="post">
    ...
    <?php if($task->permission_edit_task): ?>
      <div class="hidden" id="card-task-visibility">
        <ul class="list">
          <li class="card-tasks-update-visibility-link" data-button-text="card-task-client-visibility-text" data-progress-bar='hidden'
            data-url="<?php echo e(urlResource('/tasks/' . $task->task_id . '/update-visibility')); ?>" data-type="form" data-value="no" data-text="<?php echo e(cleanLang(__('lang.hidden'))); ?>"
            data-form-id="card-task-client-visibility" data-ajax-type="post">
            <?php echo e(cleanLang(__('lang.hidden'))); ?>

          </li>
          <li class="card-tasks-update-visibility-link" data-button-text="card-task-client-visibility-text" data-progress-bar='hidden'
            data-url="<?php echo e(urlResource('/tasks/' . $task->task_id . '/update-visibility')); ?>" data-type="form" data-value="yes" data-text="<?php echo e(cleanLang(__('lang.visible'))); ?>"
            data-form-id="card-task-client-visibility" data-ajax-type="post">
    ...
    <?php if($task->permission_edit_task): ?>
      <div class="hidden" id="card-task-milestones">
        ...
        <div class="form-group text-right">
          <button type="button" class="btn btn-danger btn-sm" id="card-tasks-update-milestone-button" data-progress-bar='hidden'
            data-url="<?php echo e(urlResource('/tasks/' . $task->task_id . '/update-milestone')); ?>" data-type="form" data-ajax-type="post" data-form-id="popover-body">
    ...
    <div class="hidden" id="card-task-team">
      <div class="card-assigned-popover-content">
        ...
        <?php $__currentLoopData = $project_assigned; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="form-check m-b-15">
            <label class="custom-control custom-checkbox">
              <input type="checkbox" name="assigned[<?php echo e($staff->id); ?>]" class="custom-control-input assigned_user_<?php echo e($staff->id); ?>">
              <span class="custom-control-indicator"></span>
              <span class="custom-control-description"><img src="<?php echo e(getUsersAvatar($staff->avatar_directory, $staff->avatar_filename)); ?>" class="img-circle avatar-xsmall">
        ...
        <div class="form-group text-right">
          <button type="button" class="btn btn-danger btn-sm" id="card-tasks-update-assigned" data-progress-bar='hidden'
            data-url="<?php echo e(urlResource('/tasks/' . $task->task_id . '/update-assigned')); ?>" data-type="form" data-ajax-type="post" data-form-id="popover-body">
            <?php echo e(cleanLang(__('lang.update'))); ?>
...
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/task/rightpanel.blade.php ENDPATH**/ ?>