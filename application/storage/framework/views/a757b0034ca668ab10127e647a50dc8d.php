                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <select class="select2-basic-with-search form-control form-control-sm"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <select class="select2-basic form-control form-control-sm"
                                    id="settings_system_close_modals_body_click"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <select class="select2-basic form-control form-control-sm"
                                    id="settings_system_session_login_popup" name="settings_system_session_login_popup">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <select class="select2-basic form-control form-control-sm"
                                    id="settings_system_language_default" name="settings_system_language_default">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/settings/sections/general/general.blade.php ENDPATH**/ ?>