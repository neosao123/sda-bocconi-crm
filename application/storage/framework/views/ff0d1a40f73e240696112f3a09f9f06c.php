...
<!--javascript-->
<script src="<?php echo e(config('constant.asset_url')); ?>/public/js/core/messages.js?v=<?php echo e(config('system.versioning')); ?>"></script>
...
<?php echo $__env->make('layout.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/messages/wrapper.blade.php ENDPATH**/ ?>