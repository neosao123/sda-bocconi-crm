  ...
  <div class="form-container">
    <div class="login-container" id="login-container">
      <div class=" text-center company__info">
        ...
        <h2 class="logo-title">Neosao CRM</h2>
      </div>
    ...
    <div class="placeholder-banner" id="banner">
      <img src="<?php echo e(url('public/documents/images/CRM2.png')); ?>" alt="" class="banner">
    </div>
  </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.wrapperauth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/authentication/login.blade.php ENDPATH**/ ?>