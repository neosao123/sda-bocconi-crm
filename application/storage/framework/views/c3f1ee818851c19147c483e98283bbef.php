    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                <i class="bi bi-funnel"></i><?php echo app('translator')->get('lang.calendar_settings'); ?>
                <span>
                    <i class="bi bi-x-circle js-close-side-panels" data-target="sidepanel-calender-settings"></i>
                </span>
            </div>
            <!--title-->
            <!--body-->
...
<!--sidebar--><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/calendar/components/misc/settings.blade.php ENDPATH**/ ?>