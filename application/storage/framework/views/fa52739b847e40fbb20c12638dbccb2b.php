...
<div class="row">
    ...
    <div class="card-contrast-panel <?php echo e(runtimeVisibility('settings-file-folders-manage', $settings->settings2_file_folders_status)); ?>"
        ...
        <div class="form-group form-group-checkbox row">
            <label class="col-sm-12 col-lg-10 col-form-label text-left"><?php echo app('translator')->get('lang.assigned_users'); ?></label>
        ...
        <div class="form-group form-group-checkbox row">
            <label class="col-sm-12 col-lg-10 col-form-label text-left"><?php echo app('translator')->get('lang.project_manager'); ?></label>
            <div class="col-sm-12 col-lg-2 text-left p-t-5">
        ...
        <div class="form-group form-group-checkbox row">
            <label class="col-sm-12 col-lg-10 col-form-label text-left"><?php echo app('translator')->get('lang.client'); ?></label>
            <div class="col-sm-12 col-lg-2 text-left p-t-5">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/neosao-sdabocconicrm/htdocs/sdabocconicrm.neosao.co.in/application/resources/views/pages/settings/sections/files/folders.blade.php ENDPATH**/ ?>