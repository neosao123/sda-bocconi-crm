                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="contacts_col_first_name"><a class="js-ajax-ux-request js-list-sorting"
                                    ...
                                    data-url="<?php echo e(urlResource('/users?action=sort&orderby=first_name&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.name'))); ?><span
                            ...
                            <?php if(config('visibility.contacts_col_client')): ?>
                                <th class="contacts_col_company"><a class="js-ajax-ux-request js-list-sorting"
                                        ...
                                        data-url="<?php echo e(urlResource('/users?action=sort&orderby=company_name&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.client'))); ?><span
                            ...
                            <th class="contacts_col_email"><a class="js-ajax-ux-request js-list-sorting" id="sort_email"
                                    ...
                                    data-url="<?php echo e(urlResource('/users?action=sort&orderby=email&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.email'))); ?><span
                            ...
                            <th class="contacts_col_phone"><a class="js-ajax-ux-request js-list-sorting" id="sort_phone"
                                    href="javascript:void(0)"
                                    data-url="<?php echo e(urlResource('/users?action=sort&orderby=phone&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.phone'))); ?><span
                                        class="sorting-icons"><i class="ti-arrows-vertical"></i></span></th>
                            <?php if(config('visibility.contacts_col_last_active')): ?>
                                <th class="contacts_col_last_active"><a class="js-ajax-ux-request js-list-sorting"
                                        ...
                                        data-url="<?php echo e(urlResource('/users?action=sort&orderby=last_seen&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.last_seen'))); ?><span
                                            class="sorting-icons"><i class="ti-arrows-vertical"></i></span></th>
                            <?php endif; ?>
...
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/contacts/components/table/table.blade.php ENDPATH**/ ?>