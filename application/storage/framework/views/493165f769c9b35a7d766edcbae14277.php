  <head>
    ...
    <!--[if lt IE 9]>
    <script src="<?php echo e(config('constant.asset_url')); ?>/public/vendor/js/html5shiv/html5shiv.js"></script>
    <script src="<?php echo e(config('constant.asset_url')); ?>/public/vendor/js/respond/respond.min.js"></script>
    <![endif]-->
    ...
    <!--boot js-->
    <script src="<?php echo e(config('constant.asset_url')); ?>/public/js/core/head.js?v=<?php echo e(config('system.versioning')); ?>"></script>
    ...
    <link href="<?php echo e(url('public/themes/default/css/custom.css?v=' . time())); ?>" rel="stylesheet" />
    <link href="<?php echo e(url('public/themes/default/css/sidebar.css?v=' . time())); ?>" rel="stylesheet" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
  </head>
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/layout/header.blade.php ENDPATH**/ ?>