...
<div class="col-md-12  col-lg-6 align-self-center text-right parent-page-actions p-b-9"
        ...
        <div id="list-page-actions">
                ...
                <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.reminder'))); ?>"
                        ...
                        class="reminder-toggle-panel-button list-actions-button btn btn-page-actions ti-alarm-clock-border waves-effect waves-dark js-toggle-reminder-panel ajax-request <?php echo e($client->reminder_status); ?>"
                ...
                <button type="button" title="<?php echo e(cleanLang(__('lang.email_client'))); ?>" id="clientSendEmail"
                        class="data-toggle-tooltip list-actions-button btn btn-page-actions ti-email-border waves-effect waves-dark js-ajax-ux-request reset-target-modal-form edit-add-modal-button"
                ...
                <span class="dropdown">
                        <button type="button" data-toggle="dropdown" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                                ...
                                class="data-toggle-tooltip list-actions-button btn btn-page-actions sl-icon-note-border  waves-effect waves-dark">
                ...
                <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.delete_client'))); ?>"
                        ...
                        data-url="<?php echo e(url('/clients/'.$client->client_id)); ?>"  >             <i class="bi bi-trash3 trash"></i>
                        </button>
                <?php endif; ?>
        </div>
</div><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/client/components/misc/actions.blade.php ENDPATH**/ ?>