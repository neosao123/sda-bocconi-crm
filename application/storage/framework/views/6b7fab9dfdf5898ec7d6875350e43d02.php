            ...
            <tr style="background: #e0e8f1; border: 0.8px solid #A9C3E9;">
                ...
                <td style="width: 50%; vertical-align:top; padding: 0px; margin: 0px;">
                  ...
                  : '-'); ?>
                        ...
                        <div class="text-div">
                            <?php echo $bill->client_vat ? 'GSTIN: ' . $bill->client_vat : '-'; ?>
...
</div><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/bill/components/elements/proforma-invoice/proforma-invoice-header.blade.php ENDPATH**/ ?>