<div class="x-section">
  ...
  <div id="card-tags-edit-tags-container" class="hidden">
    <select name="tags" id="card_tags" class="form-control form-control-sm select2-multiple <?php echo e(runtimeAllowUserTags()); ?> select2-hidden-accessible" multiple="multiple" tabindex="-1"
      aria-hidden="true">
    ...
    <div id="card-edit-tags-buttons" class="p-t-10 hidden text-right display-block">
      <button type="button" class="btn waves-effect waves-light btn-xs btn-default" id="card-tags-button-cancel"><?php echo app('translator')->get('lang.close'); ?></button>
      <button type="button" class="btn waves-effect waves-light btn-xs btn-danger ajax-request"
        data-url="<?php echo e(url('leads/' . getLeadId($lead)['leadId'] . '/update-tags?type=' . getLeadId($lead)['type'])); ?>" data-progress-bar="hidden" data-type="form" data-form-id="card-tags-container"
        data-ajax-type="post" id="card-tags-button-save"><?php echo app('translator')->get('lang.save'); ?></button>
    </div>
  </div>
</div>
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/lead/components/tags.blade.php ENDPATH**/ ?>