...
<body class="pdf-page">
  ...
  <main class="bill-pdf <?php echo e(config('css.bill_mode')); ?> <?php echo e($page['bill_mode'] ?? ''); ?>">
    <!--TERMS-->
    <div><?php echo $workorder->workorder_requirements; ?></div>
  </main>
</body>

</html>
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/workorder/components/project-requirements-pdf.blade.php ENDPATH**/ ?>