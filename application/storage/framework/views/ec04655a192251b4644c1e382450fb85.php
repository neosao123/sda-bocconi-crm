...
<aside class="left-sidebar" id="js-trigger-nav-team"> <!--[fix] keep id as "js-trigger-nav-team"-->
    ...
    <div class="scroll-sidebar" id="main-scroll-sidebar" style="background: #003e68">
        ...
        <nav class="sidebar-nav">
            <ul data-modular-id="main_menu_client" id="sidebarnav">
                ...
                <!--home-->
                <li data-modular-id="main_menu_client_home" class="sidenav-menu-item <?php echo e($page['mainmenu_home'] ?? ''); ?> menu-tooltip menu-with-tooltip" title="<?php echo e(cleanLang(__('lang.home'))); ?>">
                ...
                <li data-modular-id="main_menu_client_projects" class="sidenav-menu-item <?php echo e($page['mainmenu_projects'] ?? ''); ?> menu-tooltip menu-with-tooltip" title="<?php echo e(cleanLang(__('lang.projects'))); ?>">
                ...
                <li data-modular-id="main_menu_client_billing" class="sidenav-menu-item <?php echo e($page['mainmenu_client_billing'] ?? ''); ?>">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li class="sidenav-submenu <?php echo e($page['submenu_subscriptions'] ?? ''); ?>" id="submenu_subscriptions">
                            <a href="/subscriptions" class=" <?php echo e($page['submenu_subscriptions'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.subscriptions'))); ?></a>
                        </li>
                        <?php endif; ?>
                    </ul>
                </li>
                ...
                <li data-modular-id="main_menu_client_proposals" class="sidenav-menu-proposals <?php echo e($page['mainmenu_client_proposals'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                ...
                <li data-modular-id="main_menu_client_contracts" class="sidenav-menu-item <?php echo e($page['mainmenu_contracts'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                ...
                <!--users-->
                <?php if(auth()->user()->is_client_owner): ?>
                <li data-modular-id="main_menu_client_users" class="sidenav-menu-item <?php echo e($page['mainmenu_contacts'] ?? ''); ?> menu-tooltip menu-with-tooltip" title="<?php echo e(cleanLang(__('lang.users'))); ?>">
                ...
                <li data-modular-id="main_menu_client_tickets" class="sidenav-menu-item <?php echo e($page['mainmenu_tickets'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                ...
                <li data-modular-id="main_menu_client_knowledgebase" class="sidenav-menu-item <?php echo e($page['mainmenu_kb'] ?? ''); ?> menu-tooltip menu-with-tooltip"
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/neosao-sdabocconicrm/htdocs/sdabocconicrm.neosao.co.in/application/resources/views/nav/leftmenu-client.blade.php ENDPATH**/ ?>