...
<div class="container-fluid <?php echo e($page['mode'] ?? ''); ?>" id="invoice-container">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-12 col-lg-7 align-self-center <?php echo e($page['crumbs_special_class'] ?? ''); ?>" id="breadcrumbs">
            <!--attached to project-->
            <a id="InvoiceTitleAttached" class="<?php echo e(runtimeInvoiceAttachedProject('project-title', $bill->bill_projectid)); ?>" href="<?php echo e(_url('projects/' . $bill->bill_projectid)); ?>">
                <h3 class="text-themecolor" id="InvoiceTitleProject"><?php echo e($page['heading'] ?? ''); ?></h3>
            </a>
            <!--not attached to project-->
            <h4 id="InvoiceTitleNotAttached" class="muted <?php echo e(runtimeInvoiceAttachedProject('alternative-title', $bill->bill_projectid)); ?>"><?php echo e(cleanLang(__('lang.not_attached_to_project'))); ?></h4>
            <!--crumbs-->
            <ol class="breadcrumb">
        ...
        <?php echo $__env->make('pages.bill.components.misc.proforma-invoice.actions', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <?php if($bill->bill_type == 'amc-invoice'): ?>
        <?php echo $__env->make('pages.bill.components.misc.amc-invoice.actions', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
...
<?php echo $__env->make('layout.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/bill/wrapper.blade.php ENDPATH**/ ?>