...
<div class="row">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.project_title'))); ?></label>
    ...
    <!--show client name-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.client_name'))); ?></label>
        <div class="col-2 p-t-5">
    ...
    <!--show date created-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.date_created'))); ?></label>
        <div class="col-2 p-t-5">
    ...
    <!--show due date-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.due_date'))); ?></label>
        <div class="col-2 p-t-5">
    ...
    <!--show start date-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.start_date'))); ?></label>
        <div class="col-2 p-t-5">
    ...
    <!--show milestone-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.milestone'))); ?></label>
        <div class="col-2 p-t-5">
    ...
    <!--show priority-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.task_priority'))); ?></label>
        <div class="col-2 p-t-5">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.client_visibility'))); ?></label>
        <div class="col-2 p-t-5">
    ...
    <!--tags-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo app('translator')->get('lang.tags'); ?></label>
        <div class="col-2 p-t-5">
    ...
    <!--reminders-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo app('translator')->get('lang.reminders'); ?></label>
        <div class="col-2 p-t-5">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/settings/sections/tasks/page.blade.php ENDPATH**/ ?>