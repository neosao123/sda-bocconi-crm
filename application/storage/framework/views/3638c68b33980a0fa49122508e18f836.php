...
<div class="row">
    ...
    <div class="form-group row">
        <label class="col-9 control-label col-form-label"><?php echo app('translator')->get('lang.projects_user_permission'); ?></label>
        <div class="col-3">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-9 col-form-label text-left"><?php echo e(cleanLang(__('lang.tasks_collaboration'))); ?></label>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/neosao-sdabocconicrm/htdocs/sdabocconicrm.neosao.co.in/application/resources/views/pages/settings/sections/projects/staff-permissions.blade.php ENDPATH**/ ?>