...
<aside class="left-sidebar" id="js-trigger-nav-team">
  <!-- Sidebar scroll-->
  <div class="scroll-sidebar" id="main-scroll-sidebar" style="background: #1c3f7f">
    <!-- Sidebar navigation-->
    <nav class="sidebar-nav" id="main-sidenav">
      <ul id="sidebarnav" data-modular-id="main_menu_team">
        ...
        <!--sales-->
        <?php if(runtimeGroupMenuVibility([
                ...
                config('visibility.modules.workorder'),
                config('visibility.modules.proforma_invoice'),
                config('visibility.modules.amc_invoice'),
            ])): ?>
            ...
            <ul aria-expanded="false" class="collapse">
              <?php if(config('visibility.modules.estimates')): ?>
                <li class="sidenav-submenu <?php echo e($page['submenu_estimates'] ?? ''); ?>" id="submenu_estimates">
                  <a href="/estimates" class=" <?php echo e($page['submenu_estimates'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.estimates'))); ?></a>
                </li>
              <?php endif; ?>
              <?php if(config('visibility.modules.workorder')): ?>
                <li class="sidenav-submenu <?php echo e($page['submenu_workorder'] ?? ''); ?>" id="submenu_workorder">
                  <a href="/workorder" class=" <?php echo e($page['submenu_workorder'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.workorder'))); ?></a>
                </li>
              <?php endif; ?>
              <?php if(config('visibility.modules.proforma_invoice')): ?>
                <li class="sidenav-submenu <?php echo e($page['submenu_proforma_invoice'] ?? ''); ?>" id="submenu_proforma_invoice">
                  <a href="/proforma-invoices" class=" <?php echo e($page['submenu_proforma_invoice'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.proforma_invoice'))); ?></a>
                </li>
              <?php endif; ?>
              <?php if(config('visibility.modules.amc_invoice')): ?>
                <li class="sidenav-submenu <?php echo e($page['submenu_amc_invoice'] ?? ''); ?>" id="submenu_amc_invoice">
                  <a href="/amc-invoices" class=" <?php echo e($page['submenu_amc_invoice'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.amc_invoice'))); ?></a>
                </li>
              <?php endif; ?>
              <?php if(config('visibility.modules.invoices')): ?>
                <li class="sidenav-submenu <?php echo e($page['submenu_invoices'] ?? ''); ?>" id="submenu_invoices">
                  <a href="/invoices" class=" <?php echo e($page['submenu_invoices'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.invoices'))); ?></a>
                </li>
              <?php endif; ?>
              <?php if(config('visibility.modules.payments')): ?>
                <li class="sidenav-submenu <?php echo e($page['submenu_payments'] ?? ''); ?>" id="submenu_payments">
                  <a href="/payments" class=" <?php echo e($page['submenu_payments'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.payments'))); ?></a>
                </li>
              <?php endif; ?>
              
              <?php if(config('visibility.modules.products')): ?>
                <li class="sidenav-submenu <?php echo e($page['submenu_products'] ?? ''); ?>" id="submenu_products">
                  <a href="/products" class=" <?php echo e($page['submenu_products'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.products'))); ?></a>
                </li>
              <?php endif; ?>
              <?php if(config('visibility.modules.expenses')): ?>
                <li class="sidenav-submenu <?php echo e($page['submenu_expenses'] ?? ''); ?>" id="submenu_expenses">
                  <a href="/expenses" class=" <?php echo e($page['submenu_expenses'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.expenses'))); ?></a>
                </li>
              <?php endif; ?>
            </ul>
          </li>
        ...
        <!--support-->
        <li data-modular-id="main_menu_team_contracts" class="sidenav-menu-item <?php echo e($page['mainmenu_tickets'] ?? ''); ?>">
          <a class="has-arrow waves-effect waves-dark" href="javascript:void(0);" aria-expanded="false">
          ...
          <ul aria-expanded="false" class="collapse">
            ...
            <li class="sidenav-submenu <?php echo e($page['submenu_tickets'] ?? ''); ?>" id="submenu_tickets">
              <a href="<?php echo e(_url('/tickets')); ?>" class="<?php echo e($page['submenu_tickets'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.tickets'))); ?></a>
            </li>
            <!--canned-->
            <?php if(auth()->user()->is_team): ?>
              <li class="sidenav-submenu <?php echo e($page['submenu_canned'] ?? ''); ?>" id="submenu_canned">
                <a href="<?php echo e(_url('/canned')); ?>" class="<?php echo e($page['submenu_canned'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.canned'))); ?></a>
              </li>
            <?php endif; ?>
            <!--knowledgebase-->
            <?php if(config('visibility.modules.knowledgebase')): ?>
              <li class="sidenav-submenu <?php echo e($page['submenu_knowledgebase'] ?? ''); ?>" id="submenu_knowledgebase">
                <a href="<?php echo e(_url('/knowledgebase')); ?>" class="<?php echo e($page['submenu_canned'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.knowledgebase'))); ?></a>
              </li>
            <?php endif; ?>
            <!--messaging-->
            <?php if(config('visibility.modules.messages')): ?>
              <li class="sidenav-submenu <?php echo e($page['submenu_messages'] ?? ''); ?>" id="submenu_messages">
                <a href="<?php echo e(_url('/messages')); ?>" class="<?php echo e($page['submenu_messages'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.messages'))); ?></a>
              </li>
            <?php endif; ?>
          </ul>
        </li>
...
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/nav/leftmenu-team.blade.php ENDPATH**/ ?>