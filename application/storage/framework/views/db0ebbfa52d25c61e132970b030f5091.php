    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                <i class="bi bi-funnel"></i><?php echo e(cleanLang(__('lang.filter_tasks'))); ?>

                <span>
                    <i class="bi bi-x-circle js-close-side-panels" data-target="sidepanel-filter-tasks"></i>
                </span>
            </div>
            <!--title-->
            <!--body-->
...
<!--sidebar--><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/tasks/components/misc/filter-tasks.blade.php ENDPATH**/ ?>