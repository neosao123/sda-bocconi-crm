  ...
  <tr id="invoice_<?php echo e($invoice->bill_invoiceid); ?>">
    <?php if(config('visibility.invoices_col_checkboxes')): ?>
      <td class="invoices_col_checkbox checkitem" id="invoices_col_checkbox_<?php echo e($invoice->bill_invoiceid); ?>">
        ...
        <span class="list-checkboxes display-inline-block w-px-20">
          <input type="checkbox" id="listcheckbox-invoices-<?php echo e($invoice->bill_invoiceid); ?>" name="ids[<?php echo e($invoice->bill_invoiceid); ?>]"
    ...
    <td class="invoices_col_id" id="invoices_col_id_<?php echo e($invoice->bill_invoiceid); ?>">
      <a href="/invoices/<?php echo e($invoice->bill_invoiceid); ?>">
        <?php echo e($invoice->bill_invoiceid); ?> </a>
      <!--recurring-->
    ...
    <td class="invoices_col_invoice_id" id="invoices_col_invoice_id_<?php echo e($invoice->bill_invoiceid); ?>">
      <a href="/invoices/<?php echo e($invoice->bill_invoiceid); ?>">
    ...
    <?php endif; ?>
    <td class="invoices_col_proforma_invoice" id="invoices_col_proforma_invoice_<?php echo e($invoice->bill_invoiceid); ?>">
      <a href="/proforma-invoices/<?php echo e($invoice->bill_proforma_invoiceid); ?>"><?php echo e(str_limit($invoice->proformainvoice->formatted_bill_proforma_invoiceid ?? '---', 12)); ?></a>
    </td>
    ...
    <?php if(config('visibility.invoices_col_payments')): ?>
      <td class="invoices_col_payments" id="invoices_col_payments_<?php echo e($invoice->bill_invoiceid); ?>">
        <a href="<?php echo e(url('payments?filter_payment_invoiceid=' . $invoice->bill_invoiceid)); ?>"><?php echo e(runtimeMoneyFormat($invoice->sum_payments)); ?></a>
      </td>
    <?php endif; ?>
    ...
    <td class="invoices_col_status" id="invoices_col_status_<?php echo e($invoice->bill_invoiceid); ?>">
      ...
      <?php if($invoice->bill_publishing_type == 'scheduled' && $invoice->bill_publishing_scheduled_status == 'pending'): ?>
        <span class="label label-icons label-icons-warning" data-toggle="tooltip" data-placement="top" title="<?php echo app('translator')->get('lang.scheduled_publishing_info'); ?>: <?php echo e(runtimeDate($invoice->bill_publishing_scheduled_date)); ?>"><i
            class="sl-icon-clock"></i></span>
      <?php endif; ?>

      <?php if(config('system.settings_estimates_show_view_status') == 'yes' && auth()->user()->is_team && $invoice->bill_status != 'draft' && $invoice->bill_status != 'paid'): ?>
        <!--estimate not viewed-->
    ...
    <td class="invoices_col_action actions_column" id="invoices_col_action_<?php echo e($invoice->bill_invoiceid); ?>">
      ...
      <span class="list-table-action dropdown font-size-inherit">
        ...
        <?php if(config('visibility.action_buttons_edit')): ?>
          <a href="/invoices/<?php echo e($invoice->bill_invoiceid); ?>/edit-invoice" title="<?php echo e(cleanLang(__('lang.edit'))); ?>" class="data-toggle-action-tooltip btn btn-outline-info btn-circle btn-sm">
            <i class="sl-icon-note"></i>
          </a>
        <?php endif; ?>
        <a href="/invoices/<?php echo e($invoice->bill_invoiceid); ?>" title="<?php echo e(cleanLang(__('lang.view'))); ?>" class="data-toggle-action-tooltip btn btn-outline-info btn-circle btn-sm">
        ...
        <?php if(auth()->user()->is_team): ?>
          <span class="list-table-action dropdown font-size-inherit">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
              <?php if(config('visibility.action_buttons_edit')): ?>
                <!--quick edit-->
                <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form edit-add-modal-button" data-toggle="modal" data-target="#commonModal"
                  data-url="<?php echo e(urlResource('/invoices/' . $invoice->bill_invoiceid . '/edit')); ?>" data-loading-target="commonModalBody" data-modal-title="<?php echo e(cleanLang(__('lang.edit_invoice'))); ?>"
                  data-action-url="<?php echo e(urlResource('/invoices/' . $invoice->bill_invoiceid . '?ref=list')); ?>" data-action-method="PUT" data-action-ajax-class=""
                  data-action-ajax-loading-target="invoices-td-container">
                  <?php echo e(cleanLang(__('lang.quick_edit'))); ?>

                </a>
                <!--email to client-->
                <a class="dropdown-item confirm-action-info" href="javascript:void(0)" data-confirm-title="<?php echo e(cleanLang(__('lang.email_to_client'))); ?>"
                  data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>" data-url="<?php echo e(url('/invoices')); ?>/<?php echo e($invoice->bill_invoiceid); ?>/resend?ref=list">
                ...
                <?php if(auth()->user()->role->role_invoices > 1): ?>
                  <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form edit-add-modal-button" href="javascript:void(0)" data-toggle="modal"
                    data-target="#commonModal" data-modal-title="<?php echo e(cleanLang(__('lang.add_new_payment'))); ?>" data-url="<?php echo e(url('/payments/create?bill_invoiceid=' . $invoice->bill_invoiceid)); ?>"
                    data-action-url="<?php echo e(urlResource('/payments?ref=invoice&source=list&bill_invoiceid=' . $invoice->bill_invoiceid)); ?>" data-loading-target="actionsModalBody"
                ...
                <?php if(auth()->user()->role->role_invoices > 1): ?>
                  <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form edit-add-modal-button" href="javascript:void(0)" data-toggle="modal"
                    data-target="#commonModal" data-modal-title="<?php echo e(cleanLang(__('lang.clone_invoice'))); ?>" data-url="<?php echo e(url('/invoices/' . $invoice->bill_invoiceid . '/clone')); ?>"
                    data-action-url="<?php echo e(url('/invoices/' . $invoice->bill_invoiceid . '/clone')); ?>" data-loading-target="actionsModalBody" data-action-method="POST">
                ...
                <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form" href="javascript:void(0)" data-toggle="modal" data-target="#actionsModal"
                  data-modal-title="<?php echo e(cleanLang(__('lang.change_category'))); ?>" data-url="<?php echo e(url('/invoices/change-category')); ?>"
                  data-action-url="<?php echo e(urlResource('/invoices/change-category?id=' . $invoice->bill_invoiceid)); ?>" data-loading-target="actionsModalBody" data-action-method="POST">
                ...
                <?php if(!is_numeric($invoice->bill_projectid)): ?>
                  <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form" href="javascript:void(0)" data-toggle="modal" data-target="#actionsModal"
                    ...
                    data-action-url="<?php echo e(urlResource('/invoices/' . $invoice->bill_invoiceid . '/attach-project')); ?>" data-loading-target="actionsModalBody" data-action-method="POST">
                ...
                <a class="dropdown-item edit-add-modal-button js-ajax-ux-request reset-target-modal-form" href="javascript:void(0)" data-toggle="modal" data-target="#commonModal"
                  data-url="<?php echo e(urlResource('/invoices/' . $invoice->bill_invoiceid . '/recurring-settings?source=page')); ?>" data-loading-target="commonModalBody"
                  data-modal-title="<?php echo e(cleanLang(__('lang.recurring_settings'))); ?>" data-action-url="<?php echo e(urlResource('/invoices/' . $invoice->bill_invoiceid . '/recurring-settings?source=page')); ?>"
                ...
                <?php if($invoice->bill_recurring == 'yes'): ?>
                  <a class="dropdown-item confirm-action-info" href="javascript:void(0)" data-confirm-title="<?php echo e(cleanLang(__('lang.stop_recurring'))); ?>"
                    data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>" data-url="<?php echo e(urlResource('/invoices/' . $invoice->bill_invoiceid . '/stop-recurring')); ?>">
                    <?php echo e(cleanLang(__('lang.stop_recurring'))); ?></a>
                <?php endif; ?>
              <?php endif; ?>
              <a class="dropdown-item" href="<?php echo e(url('payments?filter_payment_invoiceid=' . $invoice->bill_invoiceid)); ?>">
...
<!--each row-->
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/invoices/components/table/ajax.blade.php ENDPATH**/ ?>