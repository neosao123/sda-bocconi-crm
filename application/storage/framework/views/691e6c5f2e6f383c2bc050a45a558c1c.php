    ...
    <div class="pull-left m-t-30 text-left bill-file-attachments">
        ...
        <div class="bill-file-attachments-wrapper" id="bill-file-attachments-wrapper">
            ...
            <div class="x-add-file-button">
                <button type="button" id="bill-file-attachments-upload-button" class="btn waves-effect waves-light btn-rounded btn-xs btn-danger"><?php echo app('translator')->get('lang.add_file_attachments'); ?></button>
            </div>
            <?php endif; ?>
        </div>
        <!--dropzone-->
        ...
        <div class="form-group row hidden" id="bill-file-attachments-dropzone-wrapper">
            <div class="col-12">
                <div class="dropzone dz-clickable fileupload_bills" id="fileupload_bills" data-upload-url="<?php echo e(runtimeURLBillAttachFiles($bill)); ?>">
                    <div class="dz-default dz-message">
                        <i class="icon-Upload-toCloud"></i>
                        <span><?php echo app('translator')->get('lang.drag_drop_file'); ?></span>
                    </div>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true" id="bill-file-attachments-close-button">
        ...
        <table class="invoice-total-table">
            ...
            <tbody id="billing-table-section-discounts" class="<?php echo e($bill->visibility_discount_row); ?>">
                <tr id="billing-sums-discount-container">
                    ...
                    <td><?php echo e(cleanLang(__('lang.discount'))); ?> <span class="x-small" id="dom-billing-discount-type">(<?php echo e($bill->bill_discount_percentage); ?>%)</span>
                    </td>
                    <?php else: ?>
            ...
            <tbody id="billing-table-section-tax" class="<?php echo e($bill->visibility_tax_row); ?>">
                ...
                <tr class="billing-sums-tax-container" id="billing-sums-tax-container-c-<?php echo e($tax->tax_id); ?>">
                    <td><?php echo e('C-GST'); ?> <span class="x-small">(<?php echo e($tax->tax_rate / 2); ?>%)</span></td>
                ...
                <tr class="billing-sums-tax-container" id="billing-sums-tax-container-s-<?php echo e($tax->tax_id); ?>">
                    <td><?php echo e('S-GST'); ?> <span class="x-small">(<?php echo e($tax->tax_rate / 2); ?>%)</span></td>
                    <td id="invoice-sums-tax-<?php echo e($tax->tax_id); ?>">
                        <span><?php echo runtimeMoneyFormatPDF(($bill->bill_amount_before_tax * $tax->tax_rate) / 100 / 2); ?></span>
                    </td>
                </tr>
                ...
                <tr class="billing-sums-tax-container" id="billing-sums-tax-container-<?php echo e($tax->tax_id); ?>">
                    <td><?php echo e('I-GST'); ?> <span class="x-small">(<?php echo e($tax->tax_rate); ?>%)</span></td>
                    <td id="invoice-sums-tax-<?php echo e($tax->tax_id); ?>">
            ...
            <tbody id="invoice-table-section-total">
                ...
                <tr class="billing-adjustment-container <?php echo e($bill->visibility_adjustment_row); ?>" id="billing-adjustment-container">
                    <td class="p-t-15 billing-adjustment-text" id="billing-adjustment-container-description">
                        <?php echo e($bill->bill_adjustment_description); ?>
...
</div><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/bill/components/elements/totals-table.blade.php ENDPATH**/ ?>