<div class="row" id="js-trigger-invoices-modal-add-edit" data-payload="<?php echo e($page['section'] ?? ''); ?>">
    <div class="col-lg-12">
        ...
        <!--client and project-->
        <?php if(config('visibility.amc_invoice_modal_client_project_fields')): ?>
        <!--client-->
        <div class="client-selector">
            ...
            <div class="client-selector-container" id="client-existing-container">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <select class="select2-basic-with-search form-control form-control-sm dynamic_bill_project_id" data-allow-clear="true" id="bill_project_id"
                            name="bill_project_id" disabled>
                        </select>
                    </div>
                </div>
        ...
        <!--invoice date-->
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label required"><?php echo e(cleanLang(__('lang.from_date'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control  form-control-sm pickadate" name="bill_from_date_add_edit" autocomplete="off" value="<?php echo e(runtimeDatepickerDate($invoice->bill_from_date ?? '')); ?>">
                <input class="mysql-date" type="hidden" name="bill_from_date" id="bill_from_date_add_edit" value="<?php echo e($invoice->bill_from_date ?? ''); ?>">
            </div>
        </div>

        <!--due date-->
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label required"><?php echo e(cleanLang(__('lang.to_date'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm pickadate" name="bill_to_date_add_edit" autocomplete="off" value="<?php echo e(runtimeDatepickerDate($invoice->bill_to_date ?? '')); ?>">
                <input class="mysql-date" type="hidden" name="bill_to_date" id="bill_to_date_add_edit" value="<?php echo e($invoice->bill_to_date ?? ''); ?>">
            </div>
        </div>
        ...
        <!--clients projects-->
        <?php if(config('visibility.amc_invoice_modal_clients_projects')): ?>
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label  required"><?php echo e(cleanLang(__('lang.project'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
...
</div><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/amc-invoices/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>