  ...
  <tr id="estimate_<?php echo e($estimate->bill_estimateid); ?>">
    <?php if(config('visibility.estimates_col_checkboxes')): ?>
      <td class="estimates_col_checkbox checkitem" id="estimates_col_checkbox_<?php echo e($estimate->bill_estimateid); ?>">
        ...
        <span class="list-checkboxes display-inline-block w-px-20">
          <input type="checkbox" id="listcheckbox-estimates-<?php echo e($estimate->bill_estimateid); ?>" name="ids[<?php echo e($estimate->bill_estimateid); ?>]"
            class="listcheckbox listcheckbox-estimates filled-in chk-col-light-blue" data-actions-container-class="estimates-checkbox-actions-container">
    ...
    <?php if(config('visibility.estimates_col_created_by')): ?>
      <td class="estimates_col_created_by" id="estimates_col_created_by_<?php echo e($estimate->bill_estimateid); ?>">
        <img src="<?php echo e(getUsersAvatar($estimate->avatar_directory, $estimate->avatar_filename)); ?>" alt="user" class="img-circle avatar-xsmall">
    ...
    <td class="estimates_col_status" id="estimates_col_status_<?php echo e($estimate->bill_estimateid); ?>">
      ...
      <?php if($estimate->bill_publishing_type == 'scheduled' && $estimate->bill_publishing_scheduled_status == 'pending'): ?>
        <span class="label label-icons label-icons-warning" data-toggle="tooltip" data-placement="top" title="<?php echo app('translator')->get('lang.scheduled_publishing_info'); ?>: <?php echo e(runtimeDate($estimate->bill_publishing_scheduled_date)); ?>"><i
            class="sl-icon-clock"></i></span>
      <?php endif; ?>

      <?php if(config('system.settings_estimates_show_view_status') == 'yes' && auth()->user()->is_team && ($estimate->bill_status == 'new' || $estimate->bill_status == 'revised')): ?>
        <!--estimate not viewed-->
      ...
      <td class="estimates_col_action actions_column" id="estimates_col_action_<?php echo e($estimate->bill_estimateid); ?>">
        ...
        <span class="list-table-action dropdown font-size-inherit">
          ...
          <?php if(config('visibility.action_buttons_edit')): ?>
            <a href="/estimates/<?php echo e($estimate->bill_estimateid); ?>/edit-estimate" title="<?php echo e(cleanLang(__('lang.edit'))); ?>" class="data-toggle-action-tooltip btn btn-outline-info btn-circle btn-sm">
              <i class="sl-icon-note"></i>
            </a>
          <?php endif; ?>
          <a href="/estimates/<?php echo e($estimate->bill_estimateid); ?>" title="<?php echo e(cleanLang(__('lang.view'))); ?>" class="data-toggle-action-tooltip btn btn-outline-info btn-circle btn-sm">
        ...
        <?php if(config('visibility.action_buttons_edit') == 'show'): ?>
          <span class="list-table-action dropdown  font-size-inherit">
            <button type="button" id="listTableAction" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="<?php echo e(cleanLang(__('lang.more'))); ?>"
              title="<?php echo e(cleanLang(__('lang.more'))); ?>" class="data-toggle-tooltip data-toggle-tooltip btn btn-outline-default-light btn-circle btn-sm">
              <i class="ti-more"></i>
            </button>
            <div class="dropdown-menu" aria-labelledby="listTableAction">

              <!--estimate url-->
              <a class="dropdown-item" href="<?php echo e(url('/estimates/view/' . $estimate->bill_uniqueid . '?action=preview')); ?>" target="_blank"><?php echo app('translator')->get('lang.estimate_url'); ?></a>
              ...
              <a class="dropdown-item confirm-action-info" href="javascript:void(0)" data-confirm-title="<?php echo e(cleanLang(__('lang.email_to_client'))); ?>"
                data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>" data-url="<?php echo e(url('/estimates')); ?>/<?php echo e($estimate->bill_estimateid); ?>/resend?ref=list">
                <?php echo e(cleanLang(__('lang.email_to_client'))); ?></a>


              <!--actions button - change status-->
              <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form" href="javascript:void(0)" data-toggle="modal" data-target="#actionsModal"
                data-modal-title="<?php echo e(cleanLang(__('lang.change_status'))); ?>" data-url="<?php echo e(urlResource('/estimates/' . $estimate->bill_estimateid . '/change-status')); ?>"
                data-action-url="<?php echo e(urlResource('/estimates/' . $estimate->bill_estimateid . '/change-status')); ?>" data-loading-target="actionsModalBody" data-action-method="POST">
                <?php echo e(cleanLang(__('lang.change_status'))); ?></a>

              <?php if(($estimate->bill_leadtype === 'customer_lead' || $estimate->bill_leadtype === 'lead') && empty($estimate->bill_clientid)): ?>
                
                <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form" href="javascript:void(0)" data-toggle="modal" data-target="#actionsModal"
                  data-modal-title="<?php echo e(cleanLang(__('lang.assign_client'))); ?>" data-url="<?php echo e(urlResource('/estimates/' . $estimate->bill_estimateid . '/assign-client')); ?>"
                  data-action-url="<?php echo e(urlResource('/estimates/' . $estimate->bill_estimateid . '/assign-client')); ?>" data-loading-target="actionsModalBody" data-action-method="POST">
                  <?php echo e(cleanLang(__('lang.assign_client'))); ?></a>
              <?php endif; ?>
              <!--actions button - change category-->
              <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form" href="javascript:void(0)" data-toggle="modal" data-target="#actionsModal"
                data-modal-title="<?php echo e(cleanLang(__('lang.change_category'))); ?>" data-url="<?php echo e(url('/estimates/change-category')); ?>"
                data-action-url="<?php echo e(urlResource('/estimates/change-category?id=' . $estimate->bill_estimateid)); ?>" data-loading-target="actionsModalBody" data-action-method="POST">
              ...
              <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form edit-add-modal-button" href="javascript:void(0)" data-toggle="modal"
                data-target="#commonModal" data-modal-title="<?php echo e(cleanLang(__('lang.clone_estimate'))); ?>" data-url="<?php echo e(url('/estimates/' . $estimate->bill_estimateid . '/clone')); ?>"
                data-action-url="<?php echo e(url('/estimates/' . $estimate->bill_estimateid . '/clone')); ?>" data-loading-target="actionsModalBody" data-action-method="POST">
              ...
              <a class="dropdown-item edit-add-modal-button js-ajax-ux-request reset-target-modal-form" href="javascript:void(0)" data-toggle="modal" data-target="#commonModal"
                data-modal-title="<?php echo e(cleanLang(__('lang.convert_to_invoice'))); ?>" data-url="<?php echo e(urlResource('/estimates/' . $estimate->bill_estimateid . '/convert-to-invoice')); ?>"
                data-action-url="<?php echo e(urlResource('/estimates/' . $estimate->bill_estimateid . '/convert-to-invoice')); ?>" data-loading-target="commonModalBody" data-action-method="POST">
              ...
              <a href="javascript:void(0)" class="dropdown-item edit-add-modal-button js-ajax-ux-request reset-target-modal-form" data-toggle="modal" data-target="#commonModal"
                data-url="<?php echo e(urlResource('/estimates/' . $estimate->bill_estimateid . '/edit-automation?ref=list')); ?>" data-loading-target="commonModalBody" data-modal-title="<?php echo app('translator')->get('lang.estimate_automation'); ?>"
                data-action-url="<?php echo e(urlResource('/estimates/' . $estimate->bill_estimateid . '/edit-automation?ref=list')); ?>" data-action-method="POST"
...
<!--each row-->
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/estimates/components/table/ajax.blade.php ENDPATH**/ ?>