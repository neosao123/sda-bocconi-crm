<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum"
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default sl-icon-trash-border waves-effect waves-dark confirm-action-danger"
        ...
        <!--archive-->
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark archive-border confirm-action-info"
            data-type="form" data-ajax-type="POST" data-form-id="tickets-list-table"
            data-url="<?php echo e(url('/tickets/archive?ref=list')); ?>"
            data-confirm-title="<?php echo app('translator')->get('lang.archive_tickets'); ?>"
            data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>" id="checkbox-actions-delete-tickets" style="border:2px solid black;font-size:18px;">
    ...
    <?php endif; ?>
</div><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/tickets/components/actions/checkbox-actions.blade.php ENDPATH**/ ?>