...
<tr id="webform_<?php echo e($webform->webform_id); ?>">
    ...
    <td class="webform_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button"
                class="data-toggle-action-tooltip sl-icon-people-border actions-modal-button btn btn-outline-info btn-circle btn-sm ajax-request"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home/neosao-sdabocconicrm/htdocs/sdabocconicrm.neosao.co.in/application/resources/views/pages/settings/sections/webforms/table/ajax.blade.php ENDPATH**/ ?>