    ...
    <td class="status_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit" >
            <button type="button" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                class="data-toggle-tooltip data-toggle-tooltip btn btn-outline-success sl-icon-note-border  btn-circle btn-sm edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.move'))); ?>"
                class="data-toggle-tooltip data-toggle-tooltip btn sl-icon-share-alt-border btn-outline-warning btn-circle btn-sm edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.delete'))); ?>" class="data-toggle-action-tooltip sl-icon-trash-border btn btn-outline-danger btn-circle btn-sm confirm-action-danger"
...
<!--each row--><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/settings/sections/leads/table/ajax.blade.php ENDPATH**/ ?>