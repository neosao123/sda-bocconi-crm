...
<tr id="webmail_template_<?php echo e($template->webmail_template_id); ?>">
    ...
    <td class="template_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            <!--edit-->
            <button type="button"
                class="btn btn-outline-success btn-circle btn-sm edit-add-modal-button sl-icon-note-border  js-ajax-ux-request reset-target-modal-form"
...
<!--each row--><?php /**PATH /home/neosao-sdabocconicrm/htdocs/sdabocconicrm.neosao.co.in/application/resources/views/pages/settings/sections/webmailtemplates/table/ajax.blade.php ENDPATH**/ ?>