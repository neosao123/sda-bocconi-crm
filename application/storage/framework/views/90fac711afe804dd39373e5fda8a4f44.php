    ...
    <form id="table-config-form">
        <div class="slimscrollright">
            <div class="rpanel-title">
                ...
                <span>
                    <i class="bi bi-x-circle js-close-side-panels" data-target="table-config-clients"></i>
                </span>
            </div>
...
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/clients/components/misc/table-config.blade.php ENDPATH**/ ?>