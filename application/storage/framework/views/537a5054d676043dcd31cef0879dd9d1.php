<div class="card-checklist" id="card-checklist">
  ...
  <?php if($lead->permission_edit_lead): ?>
    <div class="x-action">
      <a href="javascript:void(0)" class="js-card-checklist-toggle" id="card-checklist-add-new" data-action-url="<?php echo e(url('/leads/' . getLeadId($lead)['leadId'] . '/add-checklist')); ?>" data-toggle="new"
        data-type="<?php echo e(getLeadId($lead)['type']); ?>"><?php echo e(cleanLang(__('lang.add_a_new_item'))); ?></a>
    </div>
  <?php endif; ?>
</div>
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/lead/components/checklists.blade.php ENDPATH**/ ?>