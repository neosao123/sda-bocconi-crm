    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-lg-10">
            <input type="text" class="form-control form-control-sm" id="calendar_event_title" name="calendar_event_title"
        ...
        <div class="form-group form-group-checkbox row m-b-10">
            ...
            <div class="col-6 p-t-5">
                ...
                <label class="p-l-30" for="calendar_event_all_day"><?php echo app('translator')->get('lang.all_day_event'); ?>
                    <span
                        class="align-middle text-info font-16 <?php echo e(runtimeDisabledCalenderAllDayTooltip($event['extendedProps']['resource_type'] ?? '')); ?>"
                        data-toggle="tooltip" title="<?php echo app('translator')->get('lang.event_can_only_be_all_day'); ?>" data-placement="top"><i
    ...
    <div class="form-group row">
        <!--start_date-->
        <label class="col-sm-12 col-lg-2 text-left control-label col-form-label required"><?php echo app('translator')->get('lang.start_date'); ?></label>
    ...
    <div class="row">
        <div class="col-sm-12 col-lg-2">
            <div class="form-group row">
                <label class="col-sm-12 text-left control-label col-form-label required"><?php echo app('translator')->get('lang.share_with'); ?></label>
            </div>
        </div>
        <div class="col-sm-12 col-lg-10">
            <?php if(
                (isset($event['extendedProps']['resource_type']) && $event['extendedProps']['resource_type'] == 'calendarevent') ||
                ...
                <div class="form-group form-group-checkbox row">
                    <div class="col-12 p-t-5">
                        ...
                        <label class="p-l-30" for="share_with_team_members"><?php echo app('translator')->get('lang.selected_team_members'); ?>
                            ...
                            <?php if(isset($event['extendedProps']['resource_type']) && $event['extendedProps']['resource_type'] == 'project'): ?>
                            ...
                            <?php if(isset($event['extendedProps']['resource_type']) && $event['extendedProps']['resource_type'] == 'task'): ?>
                                <span class="align-middle text-info font-16" data-toggle="tooltip"
                                    title="<?php echo app('translator')->get('lang.calendar_assign_project_info'); ?>" data-placement="top"><i
                                        class="ti-info-alt"></i></span>
                            <?php endif; ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $event['extendedProps']['files']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="event_file_<?php echo e($file['file_uniqueid']); ?>">
                            ...
                            <td class="w-px-40">
                                <button type="button" class="btn btn-danger btn-circle btn-sm confirm-action-danger"
    ...
    <!--resource type-->
    <input type="hidden" name="resource_type"
        value="<?php echo e($event['extendedProps']['resource_type'] ?? 'calendarevent'); ?>">
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/calendar/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>