<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum" id="contracts-checkbox-actions-container">
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default sl-icon-trash-border waves-effect waves-dark confirm-action-danger"
            ...
            <i class="bi bi-trash3 trash"></i> <?php echo e(cleanLang(__('lang.delete'))); ?>

        </button>
        <?php endif; ?>
        <button type="button"
            class="btn btn-sm btn-default waves-effect waves-dark sl-icon-share-alt-border actions-modal-button js-ajax-ux-request"
            ...
            <?php echo e(cleanLang(__('lang.change_category'))); ?>
    ...
    <?php endif; ?>
</div><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/contracts/components/actions/checkbox-actions.blade.php ENDPATH**/ ?>