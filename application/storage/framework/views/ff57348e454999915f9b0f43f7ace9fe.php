    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                ...
                <span>
                    <i class="bi bi-x-circle js-toggle-side-panel" data-target="sidepanel-export-timesheets"></i>
                </span>
            </div>
            <!--title-->
            <!--body-->
...
<!--sidebar--><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/export/timesheets/export.blade.php ENDPATH**/ ?>