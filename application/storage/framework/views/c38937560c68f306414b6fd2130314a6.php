    ...
    <td class="timesheets_col_action">
        <span class="list-table-action dropdown  font-size-inherit">
            ...
            <span class="btn btn-outline-default btn-circle btn-sm disabled" data-toggle="tooltip"
                title="<?php echo e(cleanLang(__('lang.item_is_attached_to_invoice_cannot_be_edited'))); ?>">
                ...
                <button type="button" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                    class="data-toggle-action-tooltip btn btn-outline-success btn-circle sl-icon-note-border btn-sm edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
...
<!--each row-->
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/neosao-sdabocconicrm/htdocs/sdabocconicrm.neosao.co.in/application/resources/views/pages/timesheets/components/table/ajax.blade.php ENDPATH**/ ?>