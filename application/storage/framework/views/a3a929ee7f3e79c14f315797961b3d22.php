...
<tr id="project_<?php echo e($project->project_id); ?>">
    ...
    <td class="projects_col_status <?php echo e(config('table.tableconfig_column_22')); ?> tableconfig_column_22">
        ...
        <span class="label label-icons label-icons-default" data-toggle="tooltip" data-placement="top"
            title="<?php echo app('translator')->get('lang.archived'); ?>">           <i class="bi bi-archive archive"></i>
            </span>
        <?php endif; ?>
    </td>
    ...
    <td class="projects_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.assigned_users'))); ?>"
                class="btn btn-outline-warning btn-circle btn-sm sl-icon-people-border edit-add-modal-button js-ajax-ux-request reset-target-modal-form data-toggle-action-tooltip"
                data-toggle="modal" data-target="#commonModal"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/projects/views/list/table/ajax.blade.php ENDPATH**/ ?>