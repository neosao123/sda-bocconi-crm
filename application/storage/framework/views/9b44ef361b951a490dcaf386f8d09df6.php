...
<div class="top-nav-no-evenets">
    <img src="<?php echo e(url('/')); ?>/public/images/relax1.png" alt="No events found" />
    <div class="x-message"><?php echo e(cleanLang(__('lang.no_notifications_found'))); ?></div>
</div>
<?php endif; ?><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/events/topnav.blade.php ENDPATH**/ ?>