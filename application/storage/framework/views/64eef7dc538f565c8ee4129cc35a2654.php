...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>" id="list-page-actions-container">
  <div id="list-page-actions">
    ...
    <?php if(config('visibility.archived_tasks_toggle_button')): ?>
      <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.show_archive_tasks'))); ?>" id="pref_filter_show_archived_tasks"
        class="list-actions-button btn btn-page-actions archive-border waves-effect waves-dark js-ajax-ux-request <?php echo e(runtimeActive(auth()->user()->pref_filter_show_archived_tasks)); ?>"
    ...
    <?php if(config('visibility.own_tasks_toggle_button')): ?>
      <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.my_tasks'))); ?>" id="pref_filter_own_tasks"
        class="list-actions-button btn btn-page-actions person-border waves-effect waves-dark js-ajax-ux-request <?php echo e(runtimeActive(auth()->user()->pref_filter_own_tasks)); ?>"
    ...
    <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.hide_completed_tasks'))); ?>" id="pref_hide_completed_tasks"
      class="list-actions-button btn btn-page-actions check-grid-border waves-effect waves-dark js-ajax-ux-request <?php echo e(runtimeActive(auth()->user()->pref_hide_completed_tasks)); ?>"
    ...
    <?php if(config('visibility.stats_toggle_button')): ?>
      <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.quick_stats'))); ?>"
        ...
        data-url-temp="<?php echo e(urlResource('/')); ?>/<?php echo e(auth()->user()->team_or_contact); ?>/updatepreferences" data-url="" data-target="list-pages-stats-widget">
    ...
    <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.kanban_view'))); ?>"
      class="list-actions-button btn btn-page-actions list-border waves-effect waves-dark js-ajax-ux-request" data-url="<?php echo e(urlResource('/tasks/search?action=search&toggle=layout')); ?>">
...
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/tasks/components/misc/list-page-actions.blade.php ENDPATH**/ ?>