...
<button type="submit" id="createCustomerButton" class="btn btn-rounded-x btn-danger waves-effect text-left"
    ...
    data-ajax-type="post" data-type="form" data-form-id="convertLeadForm"><?php echo e(cleanLang(__('lang.submit'))); ?></button><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/lead/components/footer.blade.php ENDPATH**/ ?>