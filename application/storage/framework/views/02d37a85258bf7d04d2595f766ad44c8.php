<div class="row" id="js-trigger-invoices-modal-add-edit" data-payload="<?php echo e($page['section'] ?? ''); ?>">
    <div class="col-lg-12">
            ...
            <div class="client-selector-container" id="client-existing-container">
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-lg-9">
                        ...
                        <select name="bill_clientid" id="bill_clientid" class="clients_projects_proformainvoice_toggle form-control form-control-sm js-select2-basic-search-modal select2-hidden-accessible"
                            data-projects-dropdown="bill_project_id" data-feed-request-type="clients_projects" data-ajax--url="<?php echo e(url('/')); ?>/feed/company_names">
                            <!--regular invoices-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <select class="select2-basic-with-search form-control form-control-sm projects_proformainvoice_toggle dynamic_bill_project_id" data-allow-clear="true" id="bill_project_id"
                            name="bill_project_id" data-proformainvoice-dropdown="bill_proforma_invoiceid" data-feed-request-type="projects_proformainvoice" disabled>
                        </select>
                    </div>
                </div>

                <div class="form-group row">
                    <label class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.proforma_invoice'))); ?>*</label>
                    <div class="col-sm-12 col-lg-9">
                        <select class="select2-basic-with-search form-control form-control-sm dynamic_bill_proforma_invoiceid" data-allow-clear="true" id="bill_proforma_invoiceid" name="bill_proforma_invoiceid"
                            disabled>
                        </select>
                    </div>
                </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control  form-control-sm pickadate" name="bill_date_add_edit" autocomplete="off" value="<?php echo e(runtimeDatepickerDate($invoice->bill_date ?? '')); ?>">
                <input class="mysql-date" type="hidden" name="bill_date" id="bill_date_add_edit" value="<?php echo e($invoice->bill_date ?? ''); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm pickadate" name="bill_due_date_add_edit" autocomplete="off" value="<?php echo e(runtimeDatepickerDate($invoice->bill_due_date ?? '')); ?>">
                <input class="mysql-date" type="hidden" name="bill_due_date" id="bill_due_date_add_edit" value="<?php echo e($invoice->bill_due_date ?? ''); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic form-control form-control-sm" id="bill_categoryid" name="bill_categoryid">
                    ...
                    <option value="<?php echo e($category->category_id); ?>" <?php echo e(runtimePreselected($invoice->bill_categoryid ?? '', $category->category_id)); ?>><?php echo e(runtimeLang($category->category_name)); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        </div>
        ...
        <div class="hidden" id="edit_bill_recurring_toggle">
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <textarea id="bill_notes" name="bill_notes" class="tinymce-textarea"><?php echo e($invoice->bill_notes ?? ''); ?></textarea>
                </div>
            </div>


            <!-- Hide Due To Custom Logic -->
            <!-- terms-->
            <!-- <div class="form-group row">
        ...
        <!--recurring notes-->
        <div class="alert alert-info m-t-10"><ion-icon name="refresh-outline" class="refresh"></ion-icon>
            </i>
            <?php echo e(cleanLang(__('lang.recurring_invoice_options_info'))); ?>

        </div>
    </div>
</div><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/invoices/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>