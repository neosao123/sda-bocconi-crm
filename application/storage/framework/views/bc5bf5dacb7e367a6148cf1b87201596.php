...
<div class="row">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.lead_value'))); ?></label>
    ...
    <!--show category-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.category'))); ?></label>
        <div class="col-2 p-t-5">
    ...
    <!--show last contacted-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.date_last_contacted'))); ?></label>
        <div class="col-2 p-t-5">
    ...
    <!--reminder-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo app('translator')->get('lang.reminder'); ?></label>
        <div class="col-2 p-t-5">
    ...
    <!--show telephone-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.telephone'))); ?></label>
        <div class="col-2 p-t-5">
    ...
    <!--show email-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.email_address'))); ?></label>
        <div class="col-2 p-t-5">
    ...
    <!--show Source-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label"><?php echo e(cleanLang(__('lang.lead_source'))); ?></label>
        <div class="col-2 p-t-5">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/settings/sections/leads/page.blade.php ENDPATH**/ ?>