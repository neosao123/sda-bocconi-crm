...
<tr id="category_<?php echo e($category->category_id); ?>">
    ...
    <td class="categories_col_status">
        ...
        <?php else: ?>
        <span class="label label-primary"><?php echo e(cleanLang(__('lang.not_default'))); ?></span>
        <?php endif; ?>
    </td>
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <span class="btn btn-outline-default btn-circle btn-sm disabled <?php echo e(runtimePlaceholdeActionsButtons()); ?>"
                ...
                <button type="button" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                    class="data-toggle-action-tooltip btn btn-outline-success btn-circle btn-sm sl-icon-note-border  edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                ...
                <?php if(request('filter_category_type')=='project'): ?>
                <button type="button" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                    class="data-toggle-action-tooltip btn btn-outline-warning btn-circle sl-icon-people-border btn-sm edit-add-modal-button  js-ajax-ux-request reset-target-modal-form"
                    data-toggle="modal" data-target="#commonModal"
...
<!--each row--><?php /**PATH /home/neosao-sdabocconicrm/htdocs/sdabocconicrm.neosao.co.in/application/resources/views/pages/categories/components/table/ajax.blade.php ENDPATH**/ ?>