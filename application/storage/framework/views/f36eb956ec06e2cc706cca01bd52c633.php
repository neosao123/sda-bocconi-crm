<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum" id="leads-checkbox-actions-container">
    ...
    <div class="x-buttons">
        ...
        <button type="button"
            ...
            data-action-type="form" data-action-form-id="main-body" data-loading-target="actionsModalBody"
            data-skip-checkboxes-reset="TRUE" id="checkbox-actions-change-category-leads">
            <ion-icon name="people-outline" class="people"></ion-icon> <?php echo app('translator')->get('lang.assign_users'); ?>
        </button>
        <?php endif; ?>
    </div>
    <?php else: ?>
    ...
    <?php endif; ?>
</div><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/leads/components/actions/checkbox-actions.blade.php ENDPATH**/ ?>