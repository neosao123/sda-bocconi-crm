            ...
            <?php if(request('dashboard_section') == 'settings'): ?>
                ...
                <div class="sidenav-menu-item exit-panel m-b-17">
                    <a class="waves-effect waves-dark text-info" href="/home" id="settings-exit-button"
                        ...
                        <span id="settings-exit-text" class="font-14 text-white">
                            <?php echo e(str_limit(__('lang.exit_settings'), 20)); ?>
                ...
                <?php if(auth()->user()->is_team && config('visibility.modules.timetracking')): ?>
                    <li class="nav-item dropdown hidden-xs-down my-timer-container <?php echo e(runtimeVisibility('topnav-timer', request('show_users_running_timer'))); ?>"
                        ...
                        <a class="nav-link dropdown-toggle waves-effect waves-dark" href="javascript:void(0)"
                            ...
                            <span class="timer-container"><ion-icon name="alarm-outline" class="font-18"></ion-icon>
                                <span class="my-timer-time-topnav"
                                    id="my-timer-time-topnav"><?php echo clean(runtimeSecondsHumanReadable(request('users_running_timer'), false)); ?></span></span>
                        </a>
            ...
            <ul class="navbar-nav navbar-top-right my-lg-0" id="right-topnav-navbar">
                ...
                <li class="nav-item dropdown d-none d-sm-block" id="topnav-reminders-dropdown"
                    ...
                    <a class="nav-link dropdown-toggle font-22 waves-dark text-danger p-t-9  <?php echo e(request('user_has_due_reminder')); ?>"
                        ...
                        <ion-icon name="alarm-outline" class=" display-inline-block text-danger"></ion-icon>
                    </a>
                ...
                <?php if(auth()->user()->is_team && config('visibility.modules.timetracking')): ?>
                    <li class="nav-item d-none d-sm-block" id="topnav-record-time-icon">
                        <a class="nav-link waves-effect waves-dark font-22 p-t-9 p-r-10 edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                            ...
                            data-modal-title="<?php echo app('translator')->get('lang.record_your_work_time'); ?>" data-url="<?php echo e(url('/timesheets/create')); ?>"
                ...
                <?php if(config('visibility.modules.calendar')): ?>
                    <li class="nav-item">
                        <a class="nav-link waves-effect waves-dark font-22 p-t-10 p-r-10"
                            href="<?php echo e(url('/calendar')); ?>" aria-expanded="false">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <?php if(auth()->user()->role->role_projects >= 2): ?>
                                    <a href="javascript:void(0)"
                                        class="dropdown-item dropdown-item-iconed edit-add-modal-button sl-icon-people-border js-ajax-ux-request reset-target-modal-form"
                                        data-toggle="modal" data-target="#commonModal"
                                        data-url="<?php echo e(url('clients/create')); ?>" data-loading-target="commonModalBody"
                                        ...
                                        <?php echo e(cleanLang(__('lang.client'))); ?></a>
                                <?php endif; ?>
                                ...
                                <?php if(config('visibility.modules.projects') && auth()->user()->role->role_projects >= 2): ?>
                                    <a href="javascript:void(0)"
                                        ...
                                        data-toggle="modal" data-target="#commonModal"
                                        data-url="<?php echo e(url('projects/create')); ?>" data-loading-target="commonModalBody"
                                        ...
                                        <?php echo e(cleanLang(__('lang.project'))); ?></a>
                                <?php endif; ?>
                                ...
                                <?php if(config('visibility.modules.tasks') && auth()->user()->role->role_tasks >= 2): ?>
                                    <a href="javascript:void(0)"
                                        class="dropdown-item dropdown-item-iconed edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                                        data-toggle="modal" data-target="#commonModal"
                                        data-url="<?php echo e(url('/tasks/create?ref=quickadd')); ?>"
                                        ...
                                        <?php echo e(cleanLang(__('lang.task'))); ?></a>
                                <?php endif; ?>
                                ...
                                <?php if(config('visibility.modules.leads') && auth()->user()->role->role_leads >= 2): ?>
                                    <a href="javascript:void(0)"
                                        class="dropdown-item dropdown-item-iconed edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                                        data-toggle="modal" data-target="#commonModal"
                                        data-url="<?php echo e(url('/leads/create?ref=quickadd')); ?>"
                                        data-loading-target="commonModalBody"
                                        ...
                                        <?php echo e(cleanLang(__('lang.lead'))); ?></a>
                                <?php endif; ?>
                                ...
                                <?php if(config('visibility.modules.invoices') && auth()->user()->role->role_invoices >= 2): ?>
                                    <a href="javascript:void(0)"
                                        class="dropdown-item dropdown-item-iconed edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                                        data-toggle="modal" data-target="#commonModal"
                                        data-url="<?php echo e(url('/invoices/create?ref=quickadd')); ?>"
                                        data-loading-target="commonModalBody"
                                        data-modal-title="<?php echo e(cleanLang(__('lang.add_invoice'))); ?>"
                                        data-action-url="<?php echo e(url('/invoices?ref=quickadd')); ?>"
                                        ...
                                        <?php echo e(cleanLang(__('lang.invoice'))); ?></a>
                                <?php endif; ?>
                                ...
                                <?php if(config('visibility.modules.estimates') && auth()->user()->role->role_estimates >= 2): ?>
                                    <a href="javascript:void(0)"
                                        class="dropdown-item dropdown-item-iconed edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                                        data-toggle="modal" data-target="#commonModal"
                                        data-url="<?php echo e(url('/estimates/create?ref=quickadd')); ?>"
                                        data-loading-target="commonModalBody"
                                        data-modal-title="<?php echo e(cleanLang(__('lang.add_estimate'))); ?>"
                                        data-action-url="<?php echo e(url('/estimates?ref=quickadd')); ?>"
                                        data-action-method="POST" data-action-ajax-loading-target="commonModalBody"
                                        data-save-button-class="" data-project-progress="0">
                                        <i class="bi bi-calculator"></i>
                                        <?php echo e(cleanLang(__('lang.estimate'))); ?></a>
                                <?php endif; ?>
                                ...
                                <?php if(config('visibility.modules.proposals') && auth()->user()->role->role_proposals >= 2): ?>
                                    <a href="javascript:void(0)"
                                        class="dropdown-item dropdown-item-iconed edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                                        data-toggle="modal" data-target="#commonModal"
                                        data-url="<?php echo e(url('/proposals/create?ref=quickadd')); ?>"
                                        data-loading-target="commonModalBody"
                                        data-modal-title="<?php echo e(cleanLang(__('lang.add_proposal'))); ?>"
                                        data-action-url="<?php echo e(url('/proposals?ref=quickadd')); ?>"
                                        data-action-method="POST" data-action-ajax-loading-target="commonModalBody"
                                        data-save-button-class="" data-project-progress="0">
                                        <i class="bi bi-journal-bookmark-fill"></i>
                                        <?php echo e(cleanLang(__('lang.proposal'))); ?></a>
                                <?php endif; ?>
                                ...
                                <?php if(config('visibility.modules.contracts') && auth()->user()->role->role_contracts >= 2): ?>
                                    <a href="javascript:void(0)"
                                        class="dropdown-item dropdown-item-iconed edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                                        data-toggle="modal" data-target="#commonModal"
                                        data-url="<?php echo e(url('/contracts/create?ref=quickadd')); ?>"
                                        data-loading-target="commonModalBody"
                                        data-modal-title="<?php echo e(cleanLang(__('lang.add_contract'))); ?>"
                                        data-action-url="<?php echo e(url('/contracts?ref=quickadd')); ?>"
                                        data-action-method="POST" data-action-ajax-loading-target="commonModalBody"
                                        data-save-button-class="" data-project-progress="0">
                                        <i class="bi bi-file-earmark-ruled"></i>
                                        <?php echo e(cleanLang(__('lang.contract'))); ?></a>
                                <?php endif; ?>
                                ...
                                <?php if(config('visibility.modules.payments') && auth()->user()->role->role_invoices >= 2): ?>
                                    <a href="javascript:void(0)"
                                        class="dropdown-item dropdown-item-iconed edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                                        data-toggle="modal" data-target="#commonModal"
                                        data-url="<?php echo e(url('/payments/create?ref=quickadd')); ?>"
                                        data-loading-target="commonModalBody"
                                        data-modal-title="<?php echo e(cleanLang(__('lang.add_payment'))); ?>"
                                        data-action-url="<?php echo e(url('/payments?ref=quickadd')); ?>"
                                        data-action-method="POST" data-action-ajax-loading-target="commonModalBody"
                                        data-save-button-class="" data-project-progress="0">
                                        <i class="bi bi-cash-stack"></i>
                                        <?php echo e(cleanLang(__('lang.payment'))); ?></a>
                                <?php endif; ?>
                                ...
                                <?php if(config('visibility.modules.subscriptions') && auth()->user()->role->role_subscriptions >= 2): ?>
                                    <a href="javascript:void(0)"
                                        ...
                                        data-action-url="<?php echo e(url('/subscriptions?ref=quickadd')); ?>"
                                        data-action-method="POST" data-action-ajax-loading-target="commonModalBody"
                                        data-action-ajax-class="js-ajax-ux-request" data-project-progress="0">
                                        <i class="bi bi-hdd-stack"></i>
                                        <?php echo e(cleanLang(__('lang.subscription'))); ?></a>
                                <?php endif; ?>
                                ...
                                <?php if(config('visibility.modules.expenses') && auth()->user()->role->role_expenses >= 2): ?>
                                    <a href="javascript:void(0)"
                                        class="dropdown-item dropdown-item-iconed edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                                        data-toggle="modal" data-target="#commonModal"
                                        data-url="<?php echo e(url('/expenses/create?ref=quickadd')); ?>"
                                        data-loading-target="commonModalBody"
                                        data-modal-title="<?php echo e(cleanLang(__('lang.add_expense'))); ?>"
                                        data-action-url="<?php echo e(url('/expenses?ref=quickadd')); ?>"
                                        data-action-method="POST" data-action-ajax-loading-target="commonModalBody"
                                        data-save-button-class="" data-project-progress="0">
                                        <i class="bi bi-receipt-cutoff"></i>
                                        <?php echo e(cleanLang(__('lang.expense'))); ?></a>
                                <?php endif; ?>
                                ...
                                <?php if(config('visibility.modules.knowledgebase') && auth()->user()->role->role_knowledgebase >= 2): ?>
                                    <a href="javascript:void(0)"
                                        class="dropdown-item dropdown-item-iconed edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                                        data-toggle="modal" data-target="#commonModal"
                                        data-url="<?php echo e(url('kb/create')); ?>" data-loading-target="commonModalBody"
                                        data-modal-title="<?php echo e(cleanLang(__('lang.add_article'))); ?>"
                                        data-action-url="<?php echo e(url('kb')); ?>" data-action-method="POST"
                                        data-action-ajax-loading-target="commonModalBody" data-save-button-class="">
                                        <i class="bi bi-file-earmark-richtext"></i>
                                        <?php echo e(cleanLang(__('lang.article'))); ?></a>
                                <?php endif; ?>
                                ...
                                <?php if(config('visibility.modules.tickets') && auth()->user()->role->role_tickets >= 2): ?>
                                    <a class="dropdown-item dropdown-item-iconed"
                                        ...
                                        <?php echo e(cleanLang(__('lang.ticket'))); ?></a>
                                <?php endif; ?>
                                ...
                                <?php $__currentLoopData = request('system_languages'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-6">
                                        <a class="dropdown-item js-ajax-request text-capitalize"
                                            href="javascript:void(0)" data-url="<?php echo e(url('user/updatelanguage')); ?>"
                        ...
                        <ul class="dropdown-user">
                            <li>
                                <div class="dw-user-box d-flex">                                   
                                    <div class="u-text">
                                        ...
                                        <p class="text-muted" id="topnav_dropdown_email"><?php echo e(auth()->user()->email); ?>

                                        </p>
                                        <a href="javascript:void(0)"
                                            class="btn btn-rounded btn-danger btn-sm edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                                            data-toggle="modal" data-target="#commonModal"
                                            data-url="<?php echo e(url('/user/avatar')); ?>"
                            ...
                            <li>
                                <a href="javascript:void(0)"
                                    ...
                                    <i class="bi bi-person-circle p-r-4"></i>
                            ...
                            <?php if(auth()->user()->is_team): ?>
                                <li>
                                    <a href="<?php echo e(url('/notes')); ?>">
                                        <i class="bi bi-book p-r-4"></i>
                                        <?php echo e(cleanLang(__('lang.my_notes'))); ?>
                            ...
                            <?php if(auth()->user()->is_client_owner): ?>
                                ...
                                <li>
                                    <a href="javascript:void(0)"
                                        ...
                                        <i class="bi bi-pencil-square p-r-4"></i>
                                ...
                                <li>
                                    <a href="javascript:void(0)"
                                        class="edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                                        data-toggle="modal" data-target="#commonModal"
                                        data-url="<?php echo e(url('/clients/logo')); ?>" data-loading-target="commonModalBody"
                            ...
                            <li>
                                <a href="javascript:void(0)" id="topnavUpdatePasswordButton"
                                    class="edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                                    data-toggle="modal" data-target="#commonModal"
                                    data-url="<?php echo e(url('user/updatepassword')); ?>"
                                    data-loading-target="commonModalBody"
                                    ...
                                    data-action-ajax-loading-target="commonModalBody">
                                    <i class="bi bi-person-badge p-r-4"></i>
                            ...
                            <li>
                                <a href="/logout" class="btn btn-danger text-white">
                                    <i class="bi bi-box-arrow-right p-r-4"></i> <?php echo e(cleanLang(__('lang.logout'))); ?></a>
                            </li>
                        </ul>
                    </div>
                </li>
...
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/nav/topnav.blade.php ENDPATH**/ ?>