    ...
    <div id="list-page-actions">
        ...
        <?php if(config('visibility.archived_projects_toggle_button')): ?>
            <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.show_archive_projects'))); ?>"
                ...
                class="list-actions-button btn btn-page-actions archive-border waves-effect waves-dark js-ajax-ux-request <?php echo e(runtimeActive(auth()->user()->pref_filter_show_archived_projects)); ?>"
        ...
        <?php if(config('visibility.own_projects_toggle_button')): ?>
            <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.my_projects'))); ?>"
                ...
                class="list-actions-button btn btn-page-actions person-border waves-effect waves-dark js-ajax-ux-request <?php echo e(runtimeActive(auth()->user()->pref_filter_own_projects)); ?>"
        ...
        <span class="dropdown">
            <button type="button" data-toggle="dropdown" title="<?php echo app('translator')->get('lang.view_layout'); ?>" aria-haspopup="true"
                aria-expanded="false"
                class="data-toggle-tooltip  list-actions-button btn btn-page-actions grid-border waves-effect waves-dark">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                <a class="dropdown-item display-block ajax-request" href="javascript:void(0)"
                    ...
                    <i class="ti-view-list-alt display-inline-block m-t-3"></i>
                ...
                <a class="dropdown-item display-block ajax-request" href="javascript:void(0)"
                    ...
                    id="invoice-action-stop-recurring">
                    <i class="ti-layout-cta-left display-inline-block m-t-3"></i>
        ...
        <?php if(config('visibility.list_page_actions_add_button')): ?>
            <button type="button"
                class="btn-create edit-add-modal-button js-ajax-ux-request reset-target-modal-form <?php echo e($page['add_button_classes'] ?? ''); ?>"
...
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/projects/components/misc/list-page-actions.blade.php ENDPATH**/ ?>