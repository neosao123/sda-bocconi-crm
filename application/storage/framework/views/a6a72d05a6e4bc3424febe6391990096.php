        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <div class="input-group input-group-sm">
                    ...
                    <input type="number" name="<?php echo e(isset($invoice->bill_amc_invoiceid) ? 'payment_amc_invoiceid' : 'payment_invoiceid'); ?>" id="payment_invoiceid"
...
</div><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/payments/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>