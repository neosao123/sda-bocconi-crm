                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label
                                class="col-12 control-label col-form-label"><?php echo e(cleanLang(__('lang.currency_code'))); ?></label>
                            <div class="col-12">
                        ...
                        <div class="form-group row">
                            <label
                                class="col-12 control-label col-form-label"><?php echo e(cleanLang(__('lang.currency_symbol'))); ?></label>
                            <div class="col-12">
                                <input type="text" class="form-control form-control-sm"
                                    id="settings_system_currency_symbol" name="settings_system_currency_symbol"
                                    value="<?php echo e($settings->settings_system_currency_symbol); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label
                                class="col-12 control-label col-form-label"><?php echo e(cleanLang(__('lang.decimal_separator'))); ?></label>
                            <div class="col-12">
                                <select class="select2-basic form-control form-control-sm"
                                    id="settings_system_decimal_separator" name="settings_system_decimal_separator">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <select class="select2-basic form-control form-control-sm"
                                    id="settings_system_thousand_separator" name="settings_system_thousand_separator">
                                    <option value="fullstop"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <select class="select2-basic form-control form-control-sm"
                                    id="settings_system_currency_position" name="settings_system_currency_position">
                                    <option value="left"
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/settings/sections/currency/page.blade.php ENDPATH**/ ?>