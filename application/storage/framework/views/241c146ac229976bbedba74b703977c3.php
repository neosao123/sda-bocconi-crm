...
<div class="hidden" id="invoice-logic">
  ...
  <input type="number" class="decimal-field" name="bill_subtotal" id="bill_subtotal" value="<?php echo e($bill->bill_subtotal); ?>">
  ...
  <label class="col-12 text-left control-label col-form-label">bill_tax_type_define</label>
  <input type="text" name="bill_tax_type_define" id="bill_tax_type_define" value="<?php echo e($gstType); ?>">

</div>
<!-----------------------------------------------------/#LOGIC & POST HIDDEN FIELDS---------------------------------------------------------->
<?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/bill/components/elements/logic.blade.php ENDPATH**/ ?>