...
<div class="card-group table-stats-cards  <?php echo e(runtimePreferenceStatsPanelPosition(auth()->user()->stats_panel_position)); ?>" id="list-pages-stats-widget">
    ...
    <div class="card shadow shadow-xs">
        <div class="card-body">
            <div class="row">
                <div class="col-12">
...
</div><?php /**PATH /home/neosao-nscrmdevelopment/htdocs/nscrmdevelopment.neosao.co.in/application/resources/views/pages/tasks/components/misc/list-pages-stats.blade.php ENDPATH**/ ?>