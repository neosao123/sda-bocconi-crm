    ...
    public function toResponse($request)
    {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            if (request('action') == 'load') {
                ...
                $html = view($template, compact('page', 'boards', 'stats', 'categories', 'tags', 'statuses', 'fields', 'sources'))->render();
                $jsondata['dom_html'][] = array(
            ...
            return view('pages/leads/wrapper', compact('page', 'boards', 'stats', 'categories', 'tags', 'statuses', 'fields', 'sources'))->render();
        }
    }
}
