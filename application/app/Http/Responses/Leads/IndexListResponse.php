...
class IndexListResponse implements Responsable
{
    ...
    public function toResponse($request)
    {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            $html = view($template, compact('page', 'leads', 'stats', 'categories', 'tags', 'statuses', 'fields', 'sources'))->render();
            ...
            return view('pages/leads/wrapper', compact('page', 'leads', 'stats', 'categories', 'tags', 'statuses', 'fields', 'sources'))->render();
        }
    }
}
