...
class IndexListResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            $html = view($template, compact('page', 'tasks', 'stats', 'tags', 'milestones', 'statuses', 'fields', 'priorities'))->render();
            ...
            return view($template, compact('page', 'tasks', 'stats', 'tags', 'milestones', 'statuses', 'fields', 'priorities'))->render();
        }
    }
}
