...
class ShowPreviewResponse implements Responsable
{
    ...
    public function toResponse($request)
    {
        ...
        if ($has_estimate) {
            $rendered_estimate = view('pages/bill/bill-embed', compact('page', 'bill', 'document', 'taxrates', 'taxes', 'elements', 'units', 'lineitems', 'customfields', 'estimate', 'render_section'))->render();
        }

        //render the page
        $final_document = view('pages/documents/preview/page', compact('page', 'document', 'payload', 'customfields', 'estimate', 'hsncodes'))->render();
