...
class Authenticate extends Controller
{
    ...
    public function logInAction()
    {
        ...
        // Check for errors
        if ($validator->fails()) {
            abort(409, $validator->errors()->first());
        }
        ...
        if (Auth::attempt($credentials, $remember)) {
            ...
            if ($remember) {
                Cookie::queue('email', request()->email, 60 * 24 * 5); // Store for 1 year
                Cookie::queue('password', request()->password, 60 * 24 * 5); // Store for 1 year
            } else {
