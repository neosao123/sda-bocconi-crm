...
class Feed extends Controller
{
    ...
    public function projects(ProjectRepository $projectrepo)
    {
        ...
        if (request('ref') == 'quotation_projects') {
            if (auth()->user()->role->role_projects_scope == 'global') {
                $feed = $projectrepo->autocompleteQuotationProjectsFeed('', '', request('quotation_id'), request('term'));
            } else {
                $feed = $projectrepo->autocompleteQuotationProjectsFeed('', 'assigned', request('quotation_id'), request('term'));
            }
        }
