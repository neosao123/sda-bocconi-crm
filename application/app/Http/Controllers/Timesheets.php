...
class Timesheets extends Controller
{
    ...
    public function store(TaskPermissions $taskpermissions)
    {
        ...
        $messages = [
            ...
            'manual_time_hours.between' => 'Hrs must be between 0 and 999.',
            'manual_time_minutes.between' => 'Mins must be between 0 and 59.',
        ];
        ...
        $validator = Validator::make(request()->all(), [
            ...
            'manual_time_hours' => [
                'required',
                'numeric',
                'between:0,999', // Limits the value to 0-999
            ],
            'manual_time_minutes' => [
                'required',
                'numeric',
                'between:0,59', // Limits the value to 0-59
            ],
    ...
    public function update($id)
    {
        ...
        //validate - custom error messages
        $messages = [
            'manual_time_hours.between' => 'Hours must be between 0 and 999.',
            'manual_time_minutes.between' => 'Minutes must be between 0 and 59.',
            'manual_time_seconds.between' => 'Seconds must be between 0 and 59.',
        ];
