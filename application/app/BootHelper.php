...
function middlewareBootTheme()
{
    ...
    if (env('SETUP_STATUS') != 'COMPLETED') {
        //set default theme
        config([
            'theme.selected_theme_css' => config('constant.asset_url') . '/' . 'public/themes/default/css/style.css?v=1',
        ]);
        //skip this provider
        return;
    }
    ...
    config([
        ...
        //main css file
        'theme.selected_theme_css' => config('constant.asset_url') . '/' . 'public/themes/' . $settings->settings_theme_name . '/css/style.css?v=' . $settings->settings_system_javascript_versioning,
        ...
        'theme.selected_theme_pdf_css' => config('constant.asset_url') . '/' . 'public/themes/default/css/bill-pdf.css?v=' . $settings->settings_system_javascript_versioning,
        //[MT]
        'theme.selected_theme_saas_css' => config('constant.asset_url') . '/' . 'public/themes/' . $settings->settings_theme_name . '/css/saas.css?v=' . $settings->settings_system_javascript_versioning,
    ]);
