...
class Invoice extends Model
{
    ...
    {
        return $this->belongsTo('App\Models\ProformaInvoice', 'bill_proforma_invoiceid', 'bill_proforma_invoiceid');
    }
    ...
    {
        return runtimeInvoiceIdFormat($this->bill_date_wise_invoiceid, $this->bill_date);
    }
