...
class Estimate extends Model
{
    ...
    /**
     * Summary of workorder
     */
    public function workorder()
    {
        return $this->hasMany('App\Models\Workorder', 'workorder_quotation_id', 'bill_estimateid');
    }

    public function getLeadAttribute()
    {
        return match ($this->bill_leadtype) {
            'lead' => \App\Models\Lead::find($this->bill_leadid),
            'customer_lead' => \App\Models\CustomerLeads::with('client')->find($this->bill_leadid),
            default => null,
        };
    }
    ...
    {
        return runtimeEstimateIdFormat($this->bill_date_wise_invoiceid, $this->bill_date);
    }
    ...
    {
        return runtimeDate($this->bill_date);
    }
     ...
     * @return string
     */
    public function getFormattedBillExpiryDateAttribute()
    {
