...
class Client extends Model
{
    ...
    {
        return $this->hasMany('App\Models\Workorder', 'workorder_client_id', 'client_id');
    }
    ...
    /**
     * Summary of getFormattedClientidAttribute
     * @return string
     * @author shreyasm@neosao
     */
    public function getFormattedCustomeridAttribute()
    {
        return runtimeCustomerIdFormat($this->client_id);
    }
}
