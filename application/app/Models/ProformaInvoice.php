...
class ProformaInvoice extends Model
{
     ...
     */
    protected $primaryKey = 'bill_proforma_invoiceid';
    protected $dateFormat = 'Y-m-d H:i:s';
    protected $guarded = ['bill_proforma_invoiceid'];
    ...
    {
        return $this->belongsTo('App\Models\Estimate', 'bill_quotationid', 'bill_estimateid');
    }

    public function workorder()
    {
        return $this->belongsTo('App\Models\Workorder', 'bill_workorderid', 'workorder_id');
    }
    ...
    {
        return $this->hasMany('App\Models\Payment', 'payment_invoiceid', 'bill_proforma_invoiceid');
    }
     ...
     * formatted_bill_proforma_invoiceid
     * e.g. INV-000001
     */
    public function getFormattedBillProformaInvoiceidAttribute()
    {
        return runtimeProformaInvoiceIdFormat($this->bill_date_wise_proforma_invoiceid, $this->bill_date);
    }
}
