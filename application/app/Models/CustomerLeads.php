...
class CustomerLeads extends Model
{
    ...
    protected $guarded = ['customer_lead_id'];
    ...
    {
        return $this->hasMany('App\Models\Workorder', 'workorder_lead_id', 'lead_id');
    }
    ...
    /**
     * Summary of getFormattedCustomeridAttribute
     * @return string
     */
    public function getFormattedCustomeridAttribute()
    {
        return runtimeCustomerIdFormat($this->lead_clientid);
    }

    public function getFormattedClientidAttribute()
    {
        return runtimeClientIdFormat($this->lead_converted_by_leadid);
    }
}
