...
class LeadAssignedRepository
{
     ...
     * @return null
     */
    public function delete($lead_id = '', $leadsassigned_leadtype = 'lead')
    {
        ...
        $query->where('leadsassigned_leadtype', '=', $leadsassigned_leadtype);
        $query->delete();
    }
     ...
     * @return array
     */
    public function add($lead_id = '', $user_id = '', $model = 'lead')
    {
        ...
        if (is_numeric($user_id)) {
            ...
            $assigned->leadsassigned_leadtype = $model;
            $assigned->save();
            $list[] = $user_id;
