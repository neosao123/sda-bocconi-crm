...
class RoleRepository
{
    ...
    public function create()
    {
        ...
        // /**
        //  * Dt. 30-08-2024
        //  * @author : Abhi Harhse, Neosao Services
        //  * @description : Added new fields for HSN / SAC Codes
        //  */
        // $role->role_hsnsacs = (in_array(request('role_hsnsacs'), $valid)) ? request('role_hsnsacs') : 0;
        // $role->role_hsnsacs_scope = (request('role_hsnsacs_scope') == 'on') ? 'global' : 'own';
