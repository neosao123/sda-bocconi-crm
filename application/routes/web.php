...
Route::group(['prefix' => 'workorder'], function () {
    Route::any("/search", "Workorder@index");
    Route::post("/delete", "Workorder@destroy")->middleware(['demoModeCheck']);
    Route::get("/change-category", "Workorder@changeCategory");
    Route::post("/change-category", "Workorder@changeCategoryUpdate");
    Route::post("/file/upload", "Workorder@fileUpload");
    Route::post("/file/remove", "Workorder@fileRemove");
    Route::get("/{workorder}/workorder-details", "Workorder@details")->where('workorder', '[0-9]+');
    Route::post("/{workorder}/workorder-details", "Workorder@updateDescription")->where('workorder', '[0-9]+');
    Route::get("/logo", "Workorder@logo");
    Route::put("/logo", "Workorder@updateLogo")->middleware(['demoModeCheck']);
    Route::get("/{workorder}/billing-details", "Workorder@editBillingDetails")->where('workorder', '[0-9]+');
    Route::put("/{workorder}/billing-details", "Workorder@updatebillingDetails")->where('workorder', '[0-9]+');
    Route::get("/{workorder}/change-account-owner", "Workorder@changeAccountOwner");
    Route::post("/{workorder}/change-account-owner", "Workorder@changeAccountOwnerUpdate");
    Route::get("/download/requirements/{workorder}", "Workorder@downloadRequirements");
    //dynamic load
    Route::any("/{workorder}/{section}", "Workorder@showDynamic")
        ->where(['workorder' => '[0-9]+', 'section' => 'details|contacts|projects|files|workorder-files|tickets|invoices|expenses|payments|timesheets|estimates|notes']);
});
Route::any("/workorder/{x}/profile", "Workorder@profile")->where('x', '[0-9]+');
Route::resource('workorder', 'Workorder');
...
//INVOICES
Route::group(['prefix' => 'proforma-invoices'], function () {
    Route::any("/search", "ProformaInvoice@index");
    Route::post("/delete", "ProformaInvoice@destroy")->middleware(['demoModeCheck']);
    Route::get("/change-category", "ProformaInvoice@changeCategory");
    Route::post("/change-category", "ProformaInvoice@changeCategoryUpdate");
    Route::get("/add-payment", "ProformaInvoice@addPayment");
    Route::post("/add-payment", "ProformaInvoice@addPayment");
    Route::get("/{proformainvoice}/clone", "ProformaInvoice@createClone")->where('proformainvoice', '[0-9]+');
    Route::post("/{proformainvoice}/clone", "ProformaInvoice@storeClone")->where('proformainvoice', '[0-9]+');
    Route::get("/{proformainvoice}/stop-recurring", "ProformaInvoice@stopRecurring")->where('proformainvoice', '[0-9]+');
    Route::get("/{proformainvoice}/attach-project", "ProformaInvoice@attachProject")->where('proformainvoice', '[0-9]+');
    Route::post("/{proformainvoice}/attach-project", "ProformaInvoice@attachProjectUpdate")->where('proformainvoice', '[0-9]+');
    Route::get("/{proformainvoice}/detach-project", "ProformaInvoice@dettachProject")->where('proformainvoice', '[0-9]+');
    Route::get("/{proformainvoice}/email-client", "ProformaInvoice@emailClient")->where('proformainvoice', '[0-9]+');
    Route::get("/{proformainvoice}/download-pdf", "ProformaInvoice@downloadPDF")->where('proformainvoice', '[0-9]+');
    Route::get("/{proformainvoice}/recurring-settings", "ProformaInvoice@recurringSettings")->where('proformainvoice', '[0-9]+');
    Route::post("/{proformainvoice}/recurring-settings", "ProformaInvoice@recurringSettingsUpdate")->where('proformainvoice', '[0-9]+');
    Route::get("/{proformainvoice}/edit-invoice", "ProformaInvoice@show")->where('proformainvoice', '[0-9]+')->middleware(['proformainvoicesMiddlewareEdit', 'proformainvoicesMiddlewareShow']);
    Route::post("/{proformainvoice}/edit-invoice", "ProformaInvoice@saveInvoice")->where('proformainvoice', '[0-9]+');
    Route::get("/{proformainvoice}/pdf", "ProformaInvoice@show")->middleware(['proformainvoicesMiddlewareShow']);
    Route::get("/view/{proformainvoice}/description", "ProformaInvoice@show")->middleware(['proformainvoicesMiddlewareShow']);
    Route::get("/{proformainvoice}/publish", "ProformaInvoice@publishInvoice")->where('proformainvoice', '[0-9]+')->middleware(['proformainvoicesMiddlewareEdit', 'proformainvoicesMiddlewareShow']);
    Route::post("/{proformainvoice}/publish/scheduled", "ProformaInvoice@publishScheduledInvoice")->where('proformainvoice', '[0-9]+')->middleware(['proformainvoicesMiddlewareEdit', 'proformainvoicesMiddlewareShow']);
    Route::get("/{proformainvoice}/resend", "ProformaInvoice@resendInvoice")->where('proformainvoice', '[0-9]+')->middleware(['proformainvoicesMiddlewareEdit', 'proformainvoicesMiddlewareShow']);
    Route::get("/{proformainvoice}/stripe-payment", "ProformaInvoice@paymentStripe")->where('proformainvoice', '[0-9]+');
    Route::get("/{proformainvoice}/paypal-payment", "ProformaInvoice@paymentPaypal")->where('proformainvoice', '[0-9]+');
    Route::get("/timebilling/{project}/", "Timebilling@index")->where('project', '[0-9]+');
    Route::get("/{proformainvoice}/razorpay-payment", "ProformaInvoice@paymentRazorpay")->where('proformainvoice', '[0-9]+');
    Route::get("/{proformainvoice}/mollie-payment", "ProformaInvoice@paymentMollie")->where('proformainvoice', '[0-9]+');
    Route::get("/{proformainvoice}/tap-payment", "ProformaInvoice@paymentTap")->where('proformainvoice', '[0-9]+');
    Route::get("/{proformainvoice}/paystack-payment", "ProformaInvoice@paymentPaystack")->where('proformainvoice', '[0-9]+');
    Route::post("/{proformainvoice}/attach-files", "ProformaInvoice@attachFiles")->where('proformainvoice', '[0-9]+');
    Route::get("/delete-attachment", "ProformaInvoice@deleteFile");
    Route::post("/{proformainvoice}/change-tax-type", "ProformaInvoice@updateTaxType")->where('proformainvoice', '[0-9]+');

    //view from email link
    Route::get("/redirect/{proformainvoice}", "ProformaInvoice@redirectURL")->where('proformainvoice', '[0-9]+');
});
Route::resource('proforma-invoices', 'ProformaInvoice')->parameters(['proforma-invoices' => 'proformainvoice']);
...
Route::group(['prefix' => 'invoices'], function () {
    ...
    Route::get("/view/{invoice}/description", "Invoices@show")->middleware(['invoicesMiddlewareShow']);
...
Route::group(['prefix' => 'estimates'], function () {
    ...
    Route::get("/{estimate}/assign-client", "Estimates@assignClient")->where('estimate', '[0-9]+');
    Route::post("/{estimate}/assign-client", "Estimates@assignClientUpdate")->where('estimate', '[0-9]+');
    ...
    Route::get("/view/{estimate}/description", "Estimates@showPublic");
...
Route::group(['prefix' => 'leads'], function () {
    ...
    Route::get("/{lead}/change-lead-type", "Leads@changeLeadType")->where('lead', '[0-9]+');
    Route::post("/{lead}/change-lead-type", "Leads@changeLeadTypeUpdate")->where('lead', '[0-9]+');
...
Route::group(['prefix' => 'feed'], function () {
    ...
    Route::get("/quotation", "Feed@quotation");
    Route::get("/workorder", "Feed@workorder");
    Route::get("/techstack", "Feed@techstack");
    Route::get("/deliverables", "Feed@deliverables");
    Route::get('/proforma-invoice', 'Feed@ProformaInvoice');
...
Route::post('export/proforma-invoices', 'Export\ProformaInvoices@index');

//EXPORT ESTIMATES
Route::post('export/estimates', 'Export\Estimates@index');

//EXPORT WORKORDER
Route::post('export/workorder', 'Export\Workorder@index');

//EXPORT LEADS
Route::post('export/leads', 'Export\Lead@index');
...
/**
 * dt. 30-08-2024
 * @author: abhi harshe, #neosao
 *
 */
// Route::resource('hsnsacs', 'Hsnsacs');

Route::resource('settings/hsncodes', 'Settings\Hsncodes');


//INVOICES
Route::group(['prefix' => 'amc-invoices'], function () {
    Route::any("/search", "AmcInvoices@index");
    Route::post("/delete", "AmcInvoices@destroy")->middleware(['demoModeCheck']);
    Route::get("/change-category", "AmcInvoices@changeCategory");
    Route::post("/change-category", "AmcInvoices@changeCategoryUpdate");
    Route::get("/add-payment", "AmcInvoices@addPayment");
    Route::post("/add-payment", "AmcInvoices@addPayment");
    Route::get("/{amc_invoice}/clone", "AmcInvoices@createClone")->where('invoice', '[0-9]+');
    Route::post("/{amc_invoice}/clone", "AmcInvoices@storeClone")->where('invoice', '[0-9]+');
    Route::get("/{amc_invoice}/stop-recurring", "AmcInvoices@stopRecurring")->where('invoice', '[0-9]+');
    Route::get("/{amc_invoice}/attach-project", "AmcInvoices@attachProject")->where('invoice', '[0-9]+');
    Route::post("/{amc_invoice}/attach-project", "AmcInvoices@attachProjectUpdate")->where('invoice', '[0-9]+');
    Route::get("/{amc_invoice}/detach-project", "AmcInvoices@dettachProject")->where('invoice', '[0-9]+');
    Route::get("/{amc_invoice}/email-client", "AmcInvoices@emailClient")->where('invoice', '[0-9]+');
    Route::get("/{amc_invoice}/download-pdf", "AmcInvoices@downloadPDF")->where('invoice', '[0-9]+');
    Route::get("/{amc_invoice}/recurring-settings", "AmcInvoices@recurringSettings")->where('invoice', '[0-9]+');
    Route::post("/{amc_invoice}/recurring-settings", "AmcInvoices@recurringSettingsUpdate")->where('invoice', '[0-9]+');
    Route::get("/{amc_invoice}/edit-invoice", "AmcInvoices@show")->where('invoice', '[0-9]+')->middleware(['amcInvoicesMiddlewareEdit', 'amcInvoicesMiddlewareShow']);
    Route::post("/{amc_invoice}/edit-invoice", "AmcInvoices@saveInvoice")->where('invoice', '[0-9]+');
    Route::get("/{amc_invoice}/pdf", "AmcInvoices@show")->where('invoice', '[0-9]+')->middleware(['amcInvoicesMiddlewareShow']);
    Route::get("/view/{amc_invoice}/description", "AmcInvoices@show")->middleware(['amcInvoicesMiddlewareShow']);
    Route::get("/{amc_invoice}/publish", "AmcInvoices@publishInvoice")->where('invoice', '[0-9]+')->middleware(['amcInvoicesMiddlewareEdit', 'amcInvoicesMiddlewareShow']);
    Route::post("/{amc_invoice}/publish/scheduled", "AmcInvoices@publishScheduledInvoice")->where('invoice', '[0-9]+')->middleware(['amcInvoicesMiddlewareEdit', 'amcInvoicesMiddlewareShow']);
    Route::get("/{amc_invoice}/resend", "AmcInvoices@resendInvoice")->where('invoice', '[0-9]+')->middleware(['amcInvoicesMiddlewareEdit', 'amcInvoicesMiddlewareShow']);
    Route::get("/{amc_invoice}/stripe-payment", "AmcInvoices@paymentStripe")->where('invoice', '[0-9]+');
    Route::get("/{amc_invoice}/paypal-payment", "AmcInvoices@paymentPaypal")->where('invoice', '[0-9]+');
    Route::get("/timebilling/{project}/", "Timebilling@index")->where('project', '[0-9]+');
    Route::get("/{amc_invoice}/razorpay-payment", "AmcInvoices@paymentRazorpay")->where('invoice', '[0-9]+');
    Route::get("/{amc_invoice}/mollie-payment", "AmcInvoices@paymentMollie")->where('invoice', '[0-9]+');
    Route::get("/{amc_invoice}/tap-payment", "AmcInvoices@paymentTap")->where('invoice', '[0-9]+');
    Route::get("/{amc_invoice}/paystack-payment", "AmcInvoices@paymentPaystack")->where('invoice', '[0-9]+');
    Route::post("/{amc_invoice}/attach-files", "AmcInvoices@attachFiles")->where('estimate', '[0-9]+');
    Route::get("/delete-attachment", "AmcInvoices@deleteFile");
    Route::post("/{amc_invoice}/change-tax-type", "AmcInvoices@updateTaxType")->where('invoice', '[0-9]+');


    //view from email link
    Route::get("/redirect/{amc_invoice}", "AmcInvoices@redirectURL")->where('invoice', '[0-9]+');
});
Route::resource('amc-invoices', 'AmcInvoices');



Route::get('/test-mail', function () {
    try {
        // Static credentials (Only for testing – better to use .env in production)
        config([
            'mail.default' => 'smtp',
            'mail.mailers.smtp' => [
                'transport' => 'smtp',
                ...
                'port' => 587,
                'encryption' => 'tls',
                'username' => 'testing.neosaoservices@gmail.com', // 👈 Your Gmail
                'password' => 'your_16_char_app_password', // 👈 Google App Password
            ],
            'mail.from.address' => 'your_email@gmail.com',
            'mail.from.name' => 'Laravel Test',
        ]);

        Mail::raw('This is a test email from Laravel using Google App Password.', function ($message) {
            $message->to('receiver_email@example.com') // 👈 Change to your test email
