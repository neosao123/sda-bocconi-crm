<div class="icon-list-demo row icons-selector-overlay">
    ...
    <div class="col-sm-4 col-md-2">
        <div class="preview js-icon-selector" data-val="bi bi-search"> <i class="bi bi-search"></i></div>
    </div>
    <div class="col-sm-4 col-md-2">
        <div class="preview js-icon-selector" data-val="bi bi-search-add"> <i class="bi bi-search-add"></i></div>
    </div>
    <div class="col-sm-4 col-md-2">
        <div class="preview js-icon-selector" data-val="bi bi-search-remove"> <i class="bi bi-search-remove"></i></div>
    </div>
    <div class="col-sm-4 col-md-2">
    ...
    <div class="col-sm-4 col-md-2">
        <div class="preview js-icon-selector" data-val="sl-icon-settings"> <i class=""></i></div>
    </div>
    <div class="col-sm-4 col-md-2">
    ...
    <div class="col-sm-4 col-md-2">
        ...
        <div class="col-sm-4 col-md-2">
            <div class="preview js-icon-selector" data-val="bi bi-x-circle"><i class="bi bi-x-circle"></i></div>
        </div>
        <div class="col-sm-4 col-md-2">
        ...
        <div class="col-sm-4 col-md-2">
            <div class="preview js-icon-selector" data-val="ti-export"><i class="bi bi-cloud-arrow-down export"></i></div>
        </div>
        <div class="col-sm-4 col-md-2">
