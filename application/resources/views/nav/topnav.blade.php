                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                @if (config('visibility.modules.subscriptions') && auth()->user()->role->role_subscriptions >= 2)
                                    <a href="javascript:void(0)"
                                        ...
                                        {{ cleanLang(__('lang.subscription')) }}</a>
                                @endif
                        ...
                        <ul class="dropdown-user">
                            ...
                            <li>
                                <a href="/logout" class="btn btn-danger text-white">
                                    <i class="bi bi-box-arrow-right p-r-4"></i> {{ cleanLang(__('lang.logout')) }}</a>
                            </li>
                        </ul>
                    </div>
                </li>
