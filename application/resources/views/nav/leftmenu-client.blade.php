    ...
    <div class="scroll-sidebar" id="main-scroll-sidebar" style="background: #003e68">
        ...
        <nav class="sidebar-nav">
            <ul data-modular-id="main_menu_client" id="sidebarnav">
                ...
                <!--home-->
                <li data-modular-id="main_menu_client_home" class="sidenav-menu-item {{ $page['mainmenu_home'] ?? '' }} menu-tooltip menu-with-tooltip" title="{{ cleanLang(__('lang.home')) }}">
                ...
                <li data-modular-id="main_menu_client_projects" class="sidenav-menu-item {{ $page['mainmenu_projects'] ?? '' }} menu-tooltip menu-with-tooltip" title="{{ cleanLang(__('lang.projects')) }}">
                ...
                <li data-modular-id="main_menu_client_billing" class="sidenav-menu-item {{ $page['mainmenu_client_billing'] ?? '' }}">
                ...
                <li data-modular-id="main_menu_client_proposals" class="sidenav-menu-proposals {{ $page['mainmenu_client_proposals'] ?? '' }} menu-tooltip menu-with-tooltip"
                ...
                <li data-modular-id="main_menu_client_contracts" class="sidenav-menu-item {{ $page['mainmenu_contracts'] ?? '' }} menu-tooltip menu-with-tooltip"
                ...
                <!--users-->
                @if (auth()->user()->is_client_owner)
                <li data-modular-id="main_menu_client_users" class="sidenav-menu-item {{ $page['mainmenu_contacts'] ?? '' }} menu-tooltip menu-with-tooltip" title="{{ cleanLang(__('lang.users')) }}">
                ...
                <li data-modular-id="main_menu_client_tickets" class="sidenav-menu-item {{ $page['mainmenu_tickets'] ?? '' }} menu-tooltip menu-with-tooltip"
                ...
                <li data-modular-id="main_menu_client_knowledgebase" class="sidenav-menu-item {{ $page['mainmenu_kb'] ?? '' }} menu-tooltip menu-with-tooltip"
