    ...
    <td class="col_tasks_actions actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="@lang('lang.delete')"
                class="btn btn-outline-danger btn-circle sl-icon-trash-border btn-sm confirm-action-danger"
            ...
            <button type="button" title="@lang('lang.edit')"
                class="btn btn-outline-success btn-circle sl-icon-note-border  btn-sm edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
