...
<div class="col-md-12  col-lg-6 align-self-center text-right parent-page-actions p-b-9"
        ...
        <div id="list-page-actions">
                ...
                <button type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.reminder')) }}"
                        ...
                        class="reminder-toggle-panel-button list-actions-button btn btn-page-actions ti-alarm-clock-border waves-effect waves-dark js-toggle-reminder-panel ajax-request {{ $client->reminder_status }}"
                ...
                <button type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.delete_client')) }}"
                        ...
                        data-url="{{ url('/clients/'.$client->client_id) }}"  >             <i class="bi bi-trash3 trash"></i>
                        </button>
                @endif
        </div>
</div>