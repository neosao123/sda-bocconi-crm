    ...
    <div id="list-page-actions">
        ...
        @if (config('visibility.modules.reminders'))
            <button type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.reminder')) }}"
                ...
                class="reminder-toggle-panel-button list-actions-button btn btn-page-actions ti-alarm-clock-border waves-effect waves-dark js-toggle-reminder-panel ajax-request {{ $project->reminder_status }}"
        ...
        @if (config('visibility.delete_project_button'))
            ...
            <button type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.delete_project')) }}"
                ...
                data-url="{{ url('/projects/' . $project->project_id . '?source=page') }}">
