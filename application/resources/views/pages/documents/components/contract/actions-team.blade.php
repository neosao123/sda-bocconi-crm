...
<div class="col-md-12  col-lg-6 align-self-center text-right parent-page-actions p-b-9"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" data-toggle="tooltip" title="@lang('lang.send_email')"
            class="list-actions-button btn btn-page-actions ti-email-border waves-effect waves-dark confirm-action-info"
            ...
            id="document-action-email" ><ion-icon name="mail-outline" class="email"></ion-icon></button>
        ...
        <span class="dropdown">
            <button type="button" data-toggle="dropdown" title="{{ cleanLang(__('lang.edit')) }}" aria-haspopup="true"
                aria-expanded="false"
                class="data-toggle-tooltip list-actions-button btn sl-icon-wrench-border btn-page-actions waves-effect waves-dark">
        ...
        <a data-toggle="tooltip" title="@lang('lang.exit_editing_mode')"
            ...
            class="list-actions-button btn btn-page-actions waves-effect waves-dark" style="border:2px solid #00aaff;font-size:18px;border-radius: 50px;">
        ...
        <button type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.delete_contract')) }}"
            ...
            data-url="{{ url('/contracts/'.$document->doc_id.'?source=page') }}" ></i></button>
        @endif
    </div>
</div>
<!-- action buttons -->