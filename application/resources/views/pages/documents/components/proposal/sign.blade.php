...
<script src="{{config('constant.asset_url')}}/public/vendor/js/signaturepad/signature_pad.min.js?v={{ config('system.versioning') }}"></script>
<script src="{{config('constant.asset_url')}}/public/js/dynamic/sign.document.js?v={{ config('system.versioning') }}"></script>