        ...
        <div class="form-group form-group-checkbox row m-b-10">
            ...
            <div class="col-6 p-t-5">
                ...
                <label class="p-l-30" for="calendar_event_all_day">@lang('lang.all_day_event')
                    <span
                        class="align-middle text-info font-16 {{ runtimeDisabledCalenderAllDayTooltip($event['extendedProps']['resource_type'] ?? '') }}"
                        data-toggle="tooltip" title="@lang('lang.event_can_only_be_all_day')" data-placement="top"><i
    ...
    <div class="form-group row">
        <!--start_date-->
        <label class="col-sm-12 col-lg-2 text-left control-label col-form-label required">@lang('lang.start_date')</label>
    ...
    <div class="row">
        <div class="col-sm-12 col-lg-2">
            <div class="form-group row">
                <label class="col-sm-12 text-left control-label col-form-label required">@lang('lang.share_with')</label>
            </div>
        </div>
        <div class="col-sm-12 col-lg-10">
            @if (
                ...
                <div class="form-group form-group-checkbox row">
                    <div class="col-12 p-t-5">
                        ...
                        <label class="p-l-30" for="share_with_team_members">@lang('lang.selected_team_members')
                            ...
                            @if (isset($event['extendedProps']['resource_type']) && $event['extendedProps']['resource_type'] == 'project')
                            ...
                            @if (isset($event['extendedProps']['resource_type']) && $event['extendedProps']['resource_type'] == 'task')
                                <span class="align-middle text-info font-16" data-toggle="tooltip"
                                    title="@lang('lang.calendar_assign_project_info')" data-placement="top"><i
                                        class="ti-info-alt"></i></span>
                            @endif
    ...
    <input type="hidden" name="resource_type"
        value="{{ $event['extendedProps']['resource_type'] ?? 'calendarevent' }}">
