<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum"
    ...
    <div class="x-buttons">
        ...
        @endif
        <button type="button"
            class="btn btn-sm btn-default sl-icon-share-alt-border waves-effect waves-dark actions-modal-button js-ajax-ux-request"
        ...
        <!--assign users-->
        <button type="button"
            class="btn btn-sm btn-default sl-icon-people-border waves-effect waves-dark actions-modal-button js-ajax-ux-request"
