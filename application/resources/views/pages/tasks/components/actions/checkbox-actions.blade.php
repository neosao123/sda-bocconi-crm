...
<div class="col-md-12 col-lg-7 align-self-center hidden checkbox-actions" id="tasks-checkbox-actions-container">
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-page-actions sl-icon-trash-border waves-effect waves-dark confirm-action-danger" 
                data-type="form"
                data-ajax-type="POST" 
        ...
        @endif
        <button type="button"
            class="btn btn-page-actions waves-effect waves-dark actions-modal-button sl-icon-share-alt-border js-ajax-ux-request"
