                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label
                                class="col-12 control-label col-form-label">{{ cleanLang(__('lang.currency_code')) }}</label>
                            <div class="col-12">
                        ...
                        <div class="form-group row">
                            <label
                                class="col-12 control-label col-form-label">{{ cleanLang(__('lang.currency_symbol')) }}</label>
                            <div class="col-12">
                                <input type="text" class="form-control form-control-sm"
                                    id="settings_system_currency_symbol" name="settings_system_currency_symbol"
                                    value="{{ $settings->settings_system_currency_symbol }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label
                                class="col-12 control-label col-form-label">{{ cleanLang(__('lang.decimal_separator')) }}</label>
                            <div class="col-12">
