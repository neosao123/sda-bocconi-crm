...
<div class="row">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label">{{ cleanLang(__('lang.lead_value')) }}</label>
    ...
    <!--show category-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label">{{ cleanLang(__('lang.category')) }}</label>
        <div class="col-2 p-t-5">
    ...
    <!--show last contacted-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label">{{ cleanLang(__('lang.date_last_contacted')) }}</label>
        <div class="col-2 p-t-5">
    ...
    <!--reminder-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label">@lang('lang.reminder')</label>
        <div class="col-2 p-t-5">
    ...
    <!--show telephone-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label">{{ cleanLang(__('lang.telephone')) }}</label>
        <div class="col-2 p-t-5">
    ...
    <!--show email-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label">{{ cleanLang(__('lang.email_address')) }}</label>
        <div class="col-2 p-t-5">
    ...
    <!--show Source-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label">{{ cleanLang(__('lang.lead_source')) }}</label>
        <div class="col-2 p-t-5">
