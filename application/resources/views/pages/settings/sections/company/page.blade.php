                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label
                                class="col-12 control-label col-form-label">{{ cleanLang(__('lang.company_name')) }}</label>
                            <div class="col-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control form-control-sm" id="settings_company_country"
                                    ...
                                    value="{{ $settings->settings_company_country ?? '' }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label
                                class="col-12 control-label col-form-label">{{ cleanLang(__('lang.vat_tax_number')) }}</label>
                            <div class="col-12">
                                <input type="text" class="form-control form-control-sm" id="settings_company_gst_number"
                                    name="settings_company_gst_number"
                                    value="{{ $settings->settings_company_gst_number ?? '' }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label
                                class="col-12 control-label col-form-label">{{ cleanLang(__('lang.telephone')) }}</label>
                            <div class="col-12">
                                <input type="text" class="form-control form-control-sm" id="settings_company_telephone"
                                    name="settings_company_telephone"
                                    value="{{ $settings->settings_company_telephone ?? '' }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <input type="text" class="form-control form-control-sm"
                                    ...
                                    value="{{ $settings->settings_company_customfield_1 ?? '' }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <input type="text" class="form-control form-control-sm"
                                    ...
                                    value="{{ $settings->settings_company_customfield_2 ?? '' }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <input type="text" class="form-control form-control-sm"
                                    ...
                                    value="{{ $settings->settings_company_customfield_3 ?? '' }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <input type="text" class="form-control form-control-sm"
                                    ...
                                    value="{{ $settings->settings_company_customfield_4 ?? '' }}">
                            </div>
                        </div>
                    </div>
