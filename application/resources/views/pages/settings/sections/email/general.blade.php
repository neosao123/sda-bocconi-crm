                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label
                                class="col-12 control-label col-form-label">{{ cleanLang(__('lang.system_email_address')) }}</label>
                            <div class="col-12">
                        ...
                        <div class="form-group row">
                            <label
                                class="col-12 control-label col-form-label">{{ cleanLang(__('lang.system_from_name')) }}</label>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <select class="select2-basic form-control form-control-sm" id="settings_email_server_type"
                                    ...
                                    <option value="sendmail"
                                        ...
                                        Sendmail</option>
                                    <option value="smtp"
                                        {{ runtimePreselected('smtp', $settings->settings_email_server_type ?? '') }}>
                                        SMTP</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="text-right">
                            ...
                            <button type="button"
                                ...
                                data-url="{{ url('settings/email/testemail') }}" data-loading-target="commonModalBody"
                                data-modal-title="Send A Test Email" data-action-url="{{ url('settings/email/testemail') }}"
