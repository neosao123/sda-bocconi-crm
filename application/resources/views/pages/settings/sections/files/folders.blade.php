...
<div class="row">
    ...
    <div class="card-contrast-panel {{ runtimeVisibility('settings-file-folders-manage', $settings->settings2_file_folders_status) }}"
        ...
        <div class="form-group form-group-checkbox row">
            <label class="col-sm-12 col-lg-10 col-form-label text-left">@lang('lang.assigned_users')</label>
        ...
        <div class="form-group form-group-checkbox row">
            <label class="col-sm-12 col-lg-10 col-form-label text-left">@lang('lang.project_manager')</label>
            <div class="col-sm-12 col-lg-2 text-left p-t-5">
        ...
        <div class="form-group form-group-checkbox row">
            <label class="col-sm-12 col-lg-10 col-form-label text-left">@lang('lang.client')</label>
            <div class="col-sm-12 col-lg-2 text-left p-t-5">
