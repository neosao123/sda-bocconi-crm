...
<tr id="status_{{ $status->taskstatus_id }}">
    ...
    <td class="status_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit" >
            ...
            <button type="button" title="{{ cleanLang(__('lang.delete')) }}" class="data-toggle-action-tooltip sl-icon-trash-border btn btn-outline-danger btn-circle btn-sm confirm-action-danger"
