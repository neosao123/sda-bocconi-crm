...
<div class="row">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label text-left">{{ cleanLang(__('lang.view_tasks')) }}</label>
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label text-left required">{{ cleanLang(__('lang.task_participation')) }}**</label>
        <div class="col-2 text-left p-t-5">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label text-left required">{{ cleanLang(__('lang.create_tasks')) }}**</label>
        <div class="col-2 text-left p-t-5">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label text-left">{{ cleanLang(__('lang.view_time_sheets')) }}</label>
        <div class="col-2 text-left p-t-5">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label text-left">{{ cleanLang(__('lang.view_expenses')) }}</label>
        <div class="col-2 text-left p-t-5">
