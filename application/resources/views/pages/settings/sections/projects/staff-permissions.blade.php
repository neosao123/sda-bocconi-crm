...
<div class="row">
    ...
    <div class="form-group row">
        <label class="col-9 control-label col-form-label">@lang('lang.projects_user_permission')</label>
        <div class="col-3">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-9 col-form-label text-left">{{ cleanLang(__('lang.tasks_collaboration')) }}</label>
