...
<!--form text tem-->
    <div class="form-group row">
        <label class="col-9 control-label col-form-label">{{ cleanLang(__('lang.default_hourly_rate')) }}</label>
        <div class="col-3">
    ...
    <div class="form-group row">
        <label class="col-9 control-label col-form-label">@lang('lang.project_cover_images_feature')</label>
        <div class="col-3">
    ...
    <div class="form-group row">
        <label class="col-9 control-label col-form-label">@lang('lang.show_project_categories_main_menu')</label>
        <div class="col-3">
            <select class="select2-basic form-control form-control-sm select2-preselected"
    ...
    <div class="form-group row">
        <label class="col-9 control-label col-form-label">@lang('lang.show_task_status_changes_in_event_timeline')</label>
        <div class="col-3">
            <select class="select2-basic form-control form-control-sm select2-preselected"
