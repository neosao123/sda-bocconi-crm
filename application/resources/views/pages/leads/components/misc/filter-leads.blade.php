  ...
  <form>
    <div class="slimscrollright">
      ...
      <div class="rpanel-title">
        <i class="bi bi-funnel"></i>{{ cleanLang(__('lang.filter_leads')) }}
        <span>
      ...
      <div class="r-panel-body">
        ...
        {{-- <div class="filter-block">
          ...
          <div class="fields">
            <div class="row">
              <div class="col-md-6">
                <input type="number" class="form-control form-control-sm" placeholder="{{ cleanLang(__('lang.minimum')) }}" name="filter_lead_value_min" id="filter_lead_value_min">
              </div>
              <div class="col-md-6">
                <input type="number" class="form-control form-control-sm" placeholder="{{ cleanLang(__('lang.maximum')) }}" name="filter_lead_value_max" id="filter_lead_value_max">
              </div>
            </div>
          </div>
        </div> --}}
        ...
        <div class="filter-block">
          ...
          <div class="fields">
            <div class="row">
              <div class="col-md-12">
                <select name="filter_tags" id="filter_tags" class="form-control form-control-sm select2-multiple {{ runtimeAllowUserTags() }} select2-hidden-accessible" multiple="multiple"
                  tabindex="-1" aria-hidden="true">
                  @foreach ($tags as $tag)
            ...
            <div class="row">
              <div class="col-md-12">
                <select class="select2-basic form-control form-control-sm" data-allow-clear="true" id="filter_lead_type" name="filter_lead_type">
                  <option value=""></option>
                  <option value="inhouse">{{ __('lang.lead_type_inhouse') }}</option>
                  <option value="associate">{{ __('lang.lead_type_associate') }}</option>
                </select>
              </div>
            </div>
          </div>
        ...
        <div class="buttons-block">
          ...
          <button type="button" class="btn btn-rounded-x btn-danger js-ajax-ux-request apply-filter-button" data-url="{{ urlResource('/leads/search') }}" data-type="form"
