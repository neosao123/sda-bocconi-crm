  <head>
    ...
    <!--[if lt IE 9]>
    <script src="{{ config('constant.asset_url') }}/public/vendor/js/html5shiv/html5shiv.js"></script>
    <script src="{{ config('constant.asset_url') }}/public/vendor/js/respond/respond.min.js"></script>
    <![endif]-->
    ...
    <!--boot js-->
    <script src="{{ config('constant.asset_url') }}/public/js/core/head.js?v={{ config('system.versioning') }}"></script>
    ...
    <link href="{{ url('public/themes/default/css/custom.css?v=' . time()) }}" rel="stylesheet" />
    <link href="{{ url('public/themes/default/css/sidebar.css?v=' . time()) }}" rel="stylesheet" />
