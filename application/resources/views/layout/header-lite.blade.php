<head>
    ...
    <script src="{{config('constant.asset_url')}}/public/vendor/js/vendor-lite.header.js?v={{ config('system.versioning') }}"></script>
    ...
    <!--VENDORS CSS-->
    <link rel="stylesheet" href="{{config('constant.asset_url')}}/public/vendor/css/vendor-lite.css?v={{ config('system.versioning') }}">

    <!--THEME STYLE (always use the default theme)-->
    <link href="{{config('constant.asset_url')}}/public/themes/default/css/style.css?v={{ config('system.versioning') }}" rel="stylesheet">
