...
return [
    ...
    'ordering_proforma_invoices' => [
        'sort_by' => 'bill_proforma_invoiceid',
        'sort_order' => 'DESC',
    ],

    'ordering_amc_invoices' => [
        'sort_by' => 'bill_amc_invoiceid',
        'sort_order' => 'DESC',
    ],
     ...
     * Optional new settings. If these settings do not exist in a previous version of , a user can simply add them
     ...
     *      this will allow for using the configs in the application as if they exist for all version of 
