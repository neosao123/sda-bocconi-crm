...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('invoices', function (Blueprint $table) {
            ...
            $table->integer('bill_quotationid')->nullable();
            $table->integer('bill_workorderid')->nullable();
            $table->integer('bill_proforma_invoiceid')->nullable();
            ...
            $table->string('bill_type', 20)->default('invoice')->comment('invoice|estimate');
